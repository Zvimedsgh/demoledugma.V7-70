...
content = content.replace('VERSION: V2.236', 'VERSION: V2.237')
content = content.replace('Error in V2.236!', 'Error in V2.237!')
content = content.replace('Attribute VB_Name = "Goren_Claude_V2_236"', 'Attribute VB_Name = "Goren_Claude_V2_237"')
content = content.replace('APP_VERSION As String = "2.236"', 'APP_VERSION As String = "2.237"')
content = content.replace('APP_VERSION = "2.236"', 'APP_VERSION = "2.237"')

start_str = 'Public Sub OpenManualSheet()'
end_str = 'Public Sub OpenInstallInstructions()'
...
with open(r'c:\LEVAV PROJECT\SOURCE\Goren_Claude_V2.237.bas', 'w', encoding='utf-8') as f:
    f.write(content)
print('Generated 237')
