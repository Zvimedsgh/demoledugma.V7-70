...
ax.text(0.12, 0.085, button_text, fontsize=12, ha='center', va='center', fontfamily='Arial', color='white', fontweight='bold',
        bbox=dict(boxstyle="round,pad=0.5", fc="darkorange", ec="none"))

fig.savefig(r"C:\ledugma\DEMO\text_base_trans_v11.pdf", format='pdf', transparent=True)
print("Transparent text v11 created.")
