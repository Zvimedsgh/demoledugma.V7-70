...
' ============================================================================
' MODULE: modReports' VERSION: 9.36 (2026-06-29)
...
' V9.36 (2026-06-29 08:22:00)
' 1. Moved BuildPresentation message from F20 to F16.
' 2. Replaced UpdateFilterValueDropdown hardcoded string valList with a Range formula to bypass 255 character limit.
Public Const SYSTEM_VERSION = "9.36"
...
2785    On Error Resume Next
        With ThisWorkbook.Worksheets(CONTROL_SHEET_NAME()).Range("F16")
            .Value = ""
...
908     On Error GoTo ERR_HANDLER
        ...
        wsMain.Range("J4").Value = ChrW(1488) & ChrW(1497) & ChrW(1512) & ChrW(1493) & " " & ChrW(8364) ' Euro + € symbol
