...
780     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B6").Left + 2, wsMain.Range("B6").Top, 80, 80)
...
878     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B11").Left + 2, wsMain.Range("B11").Top, 80, 80)
...
894     shp.OnAction = "BuildPresentation"
        ...
        ' Button: Show/Hide hidden sheets - placed at B16 to align with buttons
        Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B16").Left, wsMain.Range("B16").Top, 160, 30)
