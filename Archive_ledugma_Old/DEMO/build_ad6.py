...
# Crop table accurately: from y=100 to y=480 (height = 380)
slide14.cropbox.lower_left = (0, 100)
slide14.cropbox.upper_right = (960, 480)

# We want the table to be 250 wide (same as graph)
# And stretched downwards to match the graph's height (140.6)
# Graph scaled height = 540 * scale_y_graph = 140.625
# Table cropped height = 380
scale_y_table = 140.625 / 380.0

ty_table = 25.0 - 100 * scale_y_table
...
with open(r"C:\ledugma\DEMO\Ad_190x60_PressQuality_v6.pdf", "wb") as f:
    writer.write(f)
