...
' VERSION: 7.78 (Layout matching manual user changes)
' DATE: 2026-06-23
' ============================================================================
' CHANGES IN 7.78:
'   - VERSION 7.78 MATCHES MANUAL USER LAYOUT (H:I table, M:N rate)
' ============================================================================
' CHANGES IN 7.75:
...
70      blueClr = RGB(0, 70, 140)
        ...
        wsMain.Columns("A:D").ColumnWidth = 5    ' Right margins
        wsMain.Columns("E").ColumnWidth = 15     ' Buttons (80x80) - wider so it doesn't overlap F
        wsMain.Columns("F:G").ColumnWidth = 5    ' Spacer between buttons and table
        wsMain.Columns("H:I").ColumnWidth = 16   ' Parameter Table (matches user's manual insertion)
        wsMain.Columns("J:L").ColumnWidth = 5    ' Spacer between table and rate
        wsMain.Columns("M:N").ColumnWidth = 12   ' Exchange Rate box (matches user's manual insertion)
        wsMain.Columns("O").ColumnWidth = 5      ' Spacer
        wsMain.Columns("P:Q").ColumnWidth = 12   ' Show Sheets button area
        wsMain.Columns("R:W").ColumnWidth = 5    ' Left margins
...
130     wsMain.Range("A2:D5").ClearContents
        ...
        Dim hdrRng As Range
        Set hdrRng = Union(wsMain.Range("H2"), wsMain.Range("I2"), wsMain.Range("M2"), wsMain.Range("N2"))
...
690     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("E4").Left, wsMain.Range("E4").Top, 80, 80)
700     shp.Name = "btnBuildReview"
710     shp.Fill.ForeColor.RGB = blueClr
720     shp.TextFrame2.TextRange.Text = "1" & vbCrLf & ChrW(1489) & ChrW(1491) & ChrW(1497) & ChrW(1511) & ChrW(1514) & vbCrLf & ChrW(1504) & ChrW(1514) & ChrW(1493) & ChrW(1504) & ChrW(1497) & ChrW(1501)
...
780     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("E8").Left, wsMain.Range("E8").Top, 80, 80)
790     shp.Name = "btnApplyCorrections"
800     shp.Fill.ForeColor.RGB = RGB(0, 120, 60)
810     shp.TextFrame2.TextRange.Text = "2" & vbCrLf & ChrW(1497) & ChrW(1497) & ChrW(1513) & ChrW(1493) & ChrW(1501) & vbCrLf & ChrW(1493) & ChrW(1491) & ChrW(1493) & ChrW(34) & ChrW(1495) & ChrW(1493) & ChrW(1514)
...
878     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("E12").Left, wsMain.Range("E12").Top, 80, 80)
880     shp.Name = "btnBuildPresentation"
882     shp.Fill.ForeColor.RGB = RGB(160, 80, 0)
884     shp.TextFrame2.TextRange.Text = "3" & vbCrLf & ChrW(1497) & ChrW(1497) & ChrW(1510) & ChrW(1493) & ChrW(1512) & vbCrLf & ChrW(1502) & ChrW(1510) & ChrW(1490) & ChrW(1514)
...
894     shp.OnAction = "BuildPresentation"
        ...
        ' Button: Show/Hide hidden sheets - placed at P18 to prevent cutoff
        Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("P18").Left, wsMain.Range("P18").Top, 160, 30)
        ...
        ' ---- Credit Text in E18 (same row as Show sheets, on the right) ----
        wsMain.Range("C18:D18").UnMerge
        wsMain.Range("A18:D18").UnMerge
        wsMain.Range("D18:F18").Merge
        wsMain.Range("D18").Value = ChrW(1508) & ChrW(1497) & ChrW(1514) & ChrW(1493) & ChrW(1495) & " " & ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " 054-6677396"
        wsMain.Range("D18").Font.Size = 12
        wsMain.Range("D18").Font.Bold = True
        wsMain.Range("D18").Font.Color = RGB(0, 100, 0)
        wsMain.Range("D18").HorizontalAlignment = xlCenter
        wsMain.Range("D18").VerticalAlignment = xlCenter
...
904     End If
        ...
        If IsEmpty(wsMain.Range("I9").Value) Or wsMain.Range("I9").Value = "" Then
            wsMain.Range("I9").Value = ChrW(1489) & ChrW(1495) & ChrW(1512) & ChrW(47) & ChrW(1497)
        End If
...
905     filterTypeList = ChrW(1489) & ChrW(1495) & ChrW(1512) & ChrW(47) & ChrW(1497) & "," & ChrW(1495) & ChrW(1489) & ChrW(1512) & ChrW(1492) & "," & ChrW(1496) & ChrW(1500) & ChrW(1512) & "," & ChrW(1505) & ChrW(1493) & ChrW(1499) & ChrW(1503) & "," & ChrW(1506) & ChrW(1504) & ChrW(1507) & "," & ChrW(1506) & ChrW(1504) & ChrW(1507) & " " & ChrW(1502) & ChrW(1512) & ChrW(1499) & ChrW(1494)
        ' Use direct cell reference I9 in case named range not yet defined
906     On Error Resume Next
        wsMain.Range("I9").Validation.Delete
907     wsMain.Range("I9").Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:=filterTypeList
        wsMain.Range("I10").Validation.Delete
908     On Error GoTo ERR_HANDLER
        ...
        On Error GoTo ERR_HANDLER
        ' v7.70: I3 is labeled "shnat basis" (base year), I4 is labeled "shna shoteft" (current year).
        ' Previous mapping was inverted, causing BuildReview to read the wrong year.
        ThisWorkbook.names.Add Name:="rngBaseYear", RefersTo:="='" & wsMain.Name & "'!$I$3"
        ThisWorkbook.names.Add Name:="rngCurrentYear", RefersTo:="='" & wsMain.Name & "'!$I$4"
        ThisWorkbook.names.Add Name:="rngPeriodType", RefersTo:="='" & wsMain.Name & "'!$I$5"
        ThisWorkbook.names.Add Name:="rngPeriodValue", RefersTo:="='" & wsMain.Name & "'!$I$6"
        ThisWorkbook.names.Add Name:="rngDateType", RefersTo:="='" & wsMain.Name & "'!$I$7"
        ThisWorkbook.names.Add Name:="rngFilterType", RefersTo:="='" & wsMain.Name & "'!$I$9"
        ThisWorkbook.names.Add Name:="rngFilterValue", RefersTo:="='" & wsMain.Name & "'!$I$10"

        ' ---- Client name filter (H12 label, I12 Data Validation dropdown) ----
        ' "shem lakoach" = ?? ????
        wsMain.Range("H12").Value = ChrW(1513) & ChrW(1501) & " " & ChrW(1500) & ChrW(1511) & ChrW(1493) & ChrW(1495)
        wsMain.Range("H12").Font.Bold = True
        wsMain.Range("H12").Font.Size = 12
        wsMain.Range("H12").Font.Color = RGB(0, 70, 140)

        ' Create/update named range for I12
        On Error Resume Next
        ThisWorkbook.names("rngClientName").Delete
        On Error GoTo ERR_HANDLER
        ThisWorkbook.names.Add Name:="rngClientName", RefersTo:="='" & wsMain.Name & "'!$I$12"

        ' Set default value "bechar/i" = ???/?
        If IsEmpty(wsMain.Range("I12").Value) Or wsMain.Range("I12").Value = "" Then
            wsMain.Range("I12").Value = ChrW(1489) & ChrW(1495) & ChrW(1512) & ChrW(47) & ChrW(1497)
        End If
        ...
        ' Remove Data Validation from I12 (from previous versions)
        On Error Resume Next
        wsMain.Range("I12").Validation.Delete
        On Error GoTo ERR_HANDLER

        ' Add search button next to I12 (in J12)
        ...
        Set btnSearch = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("J12").Left + 2, wsMain.Range("J12").Top + 1, _
            50, wsMain.Range("J12").Height - 2)
        ...
        ' Add "kulam" (all) button next to search - resets I12 to "bachar/i"
        Dim btnAll As Shape
        On Error Resume Next
        wsMain.Shapes("btnAllClients").Delete
        On Error GoTo ERR_HANDLER
        Set btnAll = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("J12").Left + 55, wsMain.Range("J12").Top + 1, _
            50, wsMain.Range("J12").Height - 2)
        ...
        ' v7.40: clear selection button - resets all home-page filters to defaults
        ...
        Set btnClearSel = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("J12").Left + 110, wsMain.Range("J12").Top + 1, _
            130, wsMain.Range("J12").Height - 2)
        ...
        btnClearSel.Fill.ForeColor.RGB = RGB(160, 80, 0)
        btnClearSel.TextFrame2.TextRange.Font.Fill.ForeColor.RGB = RGB(255, 255, 255)
        btnClearSel.OnAction = "ClearHomePageSelection"
        ...
        ' ---- Exchange rate info message at M5:N7 ----
        Dim rngMsg As Range
        ' Clear any old wider merge (e.g. J5:L7 from previous versions)
        wsMain.Range("M5:O7").UnMerge
        Set rngMsg = wsMain.Range("M5:N7")
        rngMsg.Merge
        ...
        ' ---- Border for exchange rate cells M3:N4 using native cell borders instead of a shape (fixes weird leftover lines) ----
        Dim rngRates As Range
        Set rngRates = wsMain.Range("M3:N4")
        On Error Resume Next
        wsMain.Shapes("shpRateBorder").Delete
        On Error GoTo ERR_HANDLER
        rngRates.BorderAround xlContinuous, xlMedium, , RGB(0, 0, 120)

        ' ---- 7.33: borders for H3:I12 (single Range.Borders block) ----
        With wsMain.Range("H3:I12").Borders
