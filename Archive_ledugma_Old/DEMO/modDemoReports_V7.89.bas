...
' ============================================================================
' MODULE: modReports' VERSION: 7.89 (Layout step: 6 buttons dynamic height matching Clear)
' PURPOSE: Complete reporting system - BuildReview + ApplyCorrectionsAndBuildReports
'          VERSION 7.89
' ============================================================================
' CHANGES IN 7.89:
'   - Added buttons 4, 5, 6
'   - Sized buttons 1-6 to match the exact bottom line of the Clear button
'   - Added ProVersionOnly macro
' ============================================================================
' CHANGES IN 7.75:
