...
' ============================================================================
' MODULE: modReports' VERSION: 7.85 (Layout step: Search/All to Row 24)
' PURPOSE: Complete reporting system - BuildReview + ApplyCorrectionsAndBuildReports
'          VERSION 7.85
' ============================================================================
' CHANGES IN 7.85:
'   - Search moved to middle of F24
'   - All moved to middle of G24
'   - Clear moved to center under both
' ============================================================================
' CHANGES IN 7.75:
...
908     On Error GoTo ERR_HANDLER
        ...
        ' Add search button (F24 centered)
        ...
        Set btnSearch = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("F24").Left + (wsMain.Range("F24").Width - 50) / 2, _
            wsMain.Range("F24").Top, 50, 25)
        ...
        ' Add "kulam" (all) button (G24 centered)
        Dim btnAll As Shape
        On Error Resume Next
        wsMain.Shapes("btnAllClients").Delete
        On Error GoTo ERR_HANDLER
        Set btnAll = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("G24").Left + (wsMain.Range("G24").Width - 50) / 2, _
            wsMain.Range("G24").Top, 50, 25)
        ...
        ' clear selection button under search buttons (Centered across F26:G26)
        ...
        Set btnClearSel = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("F26:G26").Left + (wsMain.Range("F26:G26").Width - 105) / 2, _
            wsMain.Range("F26").Top, 105, 25)
