...
' ============================================================================
' MODULE: modReports' VERSION: 7.81 (Custom Layout Adjustments)
' PURPOSE: Complete reporting system - BuildReview + ApplyCorrectionsAndBuildReports
'          VERSION 7.81
' ============================================================================
' CHANGES IN 7.81:
'   - Column A width = 42, B = 15, H:I = 13
'   - Buttons moved to B1, B6, B11
'   - Search/All buttons moved to G14, Clear button to G16
'   - Show Sheets moved to B16
'   - Credit text removed
' ============================================================================
' CHANGES IN 7.75:
...
70      blueClr = RGB(0, 70, 140)
        ...
        wsMain.Columns("C:E").ColumnWidth = 5    ' Spacer
...
894     shp.OnAction = "BuildPresentation"
        ...
        Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B2").Left, btnTop, 160, 30)
...
908     On Error GoTo ERR_HANDLER
        ...
        ' Add search button under parameters table (in G14)
        ...
        Set btnSearch = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("G14").Left, wsMain.Range("G14").Top, _
            50, 25)
        ...
        ' clear selection button under search buttons (G16)
        ...
        Set btnClearSel = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("G16").Left, wsMain.Range("G16").Top, _
            105, 25)
