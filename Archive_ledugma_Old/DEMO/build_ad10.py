...
text_pdf = PdfReader(r"C:\ledugma\DEMO\text_base_trans_v10.pdf")
...
# Graph on the right
# We slightly reduce height to 135 so the text has more breathing room
...
scale_y_table = 135.0 / cropped_height
ty_table = 30.0 - y_bottom * scale_y_table
...
with open(r"C:\ledugma\DEMO\Ad_190x60_PressQuality_v10.pdf", "wb") as f:
    writer.write(f)

print("Ad v10 created.")
