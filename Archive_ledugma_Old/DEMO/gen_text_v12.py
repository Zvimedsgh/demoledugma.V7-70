...
# Move button further to the left (from 0.12 to 0.06)
ax.text(0.06, 0.085, button_text, fontsize=12, ha='center', va='center', fontfamily='Arial', color='white', fontweight='bold',
        bbox=dict(boxstyle="round,pad=0.5", fc="darkorange", ec="none"))

fig.savefig(r"C:\ledugma\DEMO\text_base_trans_v12.pdf", format='pdf', transparent=True)
print("Transparent text v12 created.")
