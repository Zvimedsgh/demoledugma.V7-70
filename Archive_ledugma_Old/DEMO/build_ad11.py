...
text_pdf = PdfReader(r"C:\ledugma\DEMO\text_base_trans_v11.pdf")
...
# Original height 300 to map to 135
...
with open(r"C:\ledugma\DEMO\Ad_190x60_PressQuality_v11.pdf", "wb") as f:
    writer.write(f)

print("Ad v11 created.")
