...
' ============================================================================
' MODULE: modReports' VERSION: 7.86 (Layout step: Buttons to 13/14, Credit in F16)
...
'   - Search moved to F13
'   - All moved to G13
'   - Clear moved to F14:G14
'   - Credit text restored to F16
' ============================================================================
' CHANGES IN 7.75:
...
70      blueClr = RGB(0, 70, 140)
        ...
        wsMain.Columns("A").ColumnWidth = 42     ' Right margin (User requested 42)
...
787     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B2").Left + 2, wsMain.Range("B2").Top, 80, 80)
        btnTop = shp.Top + shp.Height + 5 ' 5 points gap
...
780     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B2").Left + 2, btnTop, 80, 80)
        btnTop = shp.Top + shp.Height + 5
...
878     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B2").Left + 2, btnTop, 80, 80)
        btnTop = shp.Top + shp.Height + 15 ' bit more gap before Show Sheets
...
894     shp.OnAction = "BuildPresentation"
        ...
        ' Button: Show/Hide hidden sheets - placed at L16
        ...
        ' ---- Restore Credit Text in F16:G16 ----
        On Error Resume Next
        wsMain.Range("A18:F18").UnMerge
        wsMain.Range("A18:F18").Clear
        wsMain.Range("F16:G16").Merge
        wsMain.Range("F16").Value = ChrW(1508) & ChrW(1497) & ChrW(1514) & ChrW(1493) & ChrW(1495) & " " & ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " 054-6677396"
        wsMain.Range("F16").Font.Size = 12
        wsMain.Range("F16").Font.Bold = True
        wsMain.Range("F16").Font.Color = RGB(0, 100, 0)
        wsMain.Range("F16").HorizontalAlignment = xlCenter
        wsMain.Range("F16").VerticalAlignment = xlCenter
        On Error GoTo ERR_HANDLER
...
908     On Error GoTo ERR_HANDLER
        ...
        ' Add search button (F13 centered)
        ...
        ' Add "kulam" (all) button (G13 centered)
        Dim btnAll As Shape
        On Error Resume Next
        ...
        ' clear selection button under search buttons (Centered across F14:G14)
