...
text_pdf = PdfReader(r"C:\ledugma\DEMO\text_base_trans.pdf")
...
# Table on the left
# We want original y=490 to map to 165
# Original height 300 to map to 140
scale_y_table = 140.6 / 300.0
...
with open(r"C:\ledugma\DEMO\Ad_190x60_PressQuality_v8.pdf", "wb") as f:
    writer.write(f)
