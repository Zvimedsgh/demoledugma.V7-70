...
' ============================================================================
' MODULE: modReports' VERSION: 7.87 (Layout step: Buttons tight spacing, Credit B16, J3:K4 centered)
' PURPOSE: Complete reporting system - BuildReview + ApplyCorrectionsAndBuildReports
'          VERSION 7.87
' ============================================================================
' CHANGES IN 7.87:
'   - Search and All placed tight under parameter table
'   - Clear placed tight under Search
'   - Credit moved to B16
'   - J3:K4 Centered
' ============================================================================
' CHANGES IN 7.75:
...
894     shp.OnAction = "BuildPresentation"
        ...
        ' ---- Restore Credit Text in B16:C16 ----
        On Error Resume Next
        wsMain.Range("A18:F18").UnMerge
        wsMain.Range("A18:F18").Clear
        wsMain.Range("F16:G16").UnMerge
        wsMain.Range("F16:G16").Clear
        wsMain.Range("B16:C16").Merge
        wsMain.Range("B16").Value = ChrW(1508) & ChrW(1497) & ChrW(1514) & ChrW(1493) & ChrW(1495) & " " & ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " 054-6677396"
        wsMain.Range("B16").Font.Size = 12
        wsMain.Range("B16").Font.Bold = True
        wsMain.Range("B16").Font.Color = RGB(0, 100, 0)
        wsMain.Range("B16").HorizontalAlignment = xlCenter
        wsMain.Range("B16").VerticalAlignment = xlCenter
        On Error GoTo ERR_HANDLER
...
908     On Error GoTo ERR_HANDLER
        ...
        btnSearchTop = wsMain.Range("F12").Top + wsMain.Range("F12").Height + 5 ' 5 points under table
