...
' VERSION: 7.71 (demo presentation year override & autofit)
' DATE: 2026-06-23
' ============================================================================
' CHANGES IN 7.71:
...
690     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B4").Left, wsMain.Range("B4").Top, 80, 80)
...
780     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B8").Left, wsMain.Range("B8").Top, 80, 80)
...
878     Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("B12").Left, wsMain.Range("B12").Top, 80, 80)
...
894     shp.OnAction = "BuildPresentation"
        ...
        ' ---- Credit Text in C18 (same row as Show sheets, on the right) ----
        wsMain.Range("C18:D18").UnMerge
        wsMain.Range("A18:D18").Merge
        wsMain.Range("A18").Value = ChrW(1508) & ChrW(1497) & ChrW(1514) & ChrW(1493) & ChrW(1495) & " " & ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " 054-6677396"
        wsMain.Range("A18").Font.Size = 12
        wsMain.Range("A18").Font.Bold = True
        wsMain.Range("A18").Font.Color = RGB(0, 100, 0)
        wsMain.Range("A18").HorizontalAlignment = xlCenter
        wsMain.Range("A18").VerticalAlignment = xlCenter
...
908     On Error GoTo ERR_HANDLER
        ...
        rateShp.Placement = xlMoveAndSize
...
Public Sub AutoFitHomeToScreen()
    ...
    ws.Activate
    ' Select columns A through U to fit the entire UI area to the screen
    ws.Columns("A:U").Select
