...
' ============================================================================
' MODULE: modReports' VERSION: 7.80 (Revert to 7.75 layout + Artifact Cleanup)
' PURPOSE: Complete reporting system - BuildReview + ApplyCorrectionsAndBuildReports
'          VERSION 7.80
' ============================================================================
' CHANGES IN 7.80:
'   - Added cleanup block to remove duplicate tables and boxes left by 7.76 and 7.78
'   - Exact layout of 7.75 but with buttons properly spaced in column E
' ============================================================================
' CHANGES IN 7.75:
...
70      blueClr = RGB(0, 70, 140)
        ...
        wsMain.Columns("H:I").ColumnWidth = 5    ' Spacer between table and rate
        wsMain.Columns("J:K").ColumnWidth = 12   ' Exchange Rate box (reverted to J:K)
        wsMain.Columns("L:M").ColumnWidth = 5    ' Spacer
        wsMain.Columns("N:O").ColumnWidth = 12   ' Show Sheets button area
...
894     shp.OnAction = "BuildPresentation"
        ...
        ' Button: Show/Hide hidden sheets - placed at O18 to prevent cutoff
        Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("O18").Left, wsMain.Range("O18").Top, 160, 30)
...
908     On Error GoTo ERR_HANDLER
        ...
        Set btnClearSel = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, _
            wsMain.Range("H12").Left + 110, wsMain.Range("H12").Top + 1, _
            130, wsMain.Range("H12").Height - 2)
