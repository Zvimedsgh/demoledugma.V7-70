...
510     yearVal = Trim$(CStr(ThisWorkbook.Worksheets(CONTROL_SHEET_NAME()).Range("G4").Value2))
520     If yearVal = "" Then Err.Raise vbObjectError + 1002, "BuildReview", "G4 IS EMPTY"
...
600     yearVal = Trim$(CStr(wsMain.Range("G4").Value2))
610     refYear = Trim$(CStr(wsMain.Range("G3").Value2))
620     If yearVal = "" Or refYear = "" Then Err.Raise vbObjectError + 2001, "ApplyCorrections", "G3 OR G4 IS EMPTY"
...
120     lblSugTaarih = ChrW(1505) & ChrW(1493) & ChrW(1490) & " " & ChrW(1514) & ChrW(1488) & ChrW(1512) & ChrW(1497) & ChrW(1498)
        ...
        ' Row 2: shnat basis (G3=ref year)
        ' Row 3: shna shoteft (G4=current year)
...
20      Set wsMain = ThisWorkbook.Worksheets(CONTROL_SHEET_NAME())
        ...
        Dim periodDesc As String
40      yearVal = Trim$(CStr(wsMain.Range("G4").Value2))
50      refYear = Trim$(CStr(wsMain.Range("G3").Value2))
