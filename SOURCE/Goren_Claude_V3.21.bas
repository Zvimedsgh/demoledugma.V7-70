Attribute VB_Name = "Goren_Claude_V3_21"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "3.21"


Private Const APP_DATE As String = "17/07/2026 10:00"
...
280     Dim rng As Range
    ...
    LogDebug "Finished A00_SetupMainSheet"
        ...
        If CStr(wsMsgSrc.Cells(20, 1).Value) <> "1" Then
            confirmMsg = CStr(wsMsgSrc.Cells(13, 1).Value) & vbNewLine & vbNewLine & CStr(wsMsgSrc.Cells(14, 1).Value) & vbNewLine & vbNewLine & CStr(wsMsgSrc.Cells(15, 1).Value) & vbNewLine & vbNewLine & CStr(wsMsgSrc.Cells(16, 1).Value)
            If MsgBoxU(confirmMsg, vbOKCancel + vbExclamation, CStr(wsMsgSrc.Cells(8, 1).Value)) <> vbOK Then
                Exit Sub
            End If
            ' Ask if user wants to keep showing this message
            If MsgBoxU(CStr(wsMsgSrc.Cells(17, 1).Value), vbYesNo + vbQuestion) = vbNo Then
...
377         If Not IsProtectedSheet(wsCleanup.Name, refBaseKeep, refBaseKeepOld) Then
                On Error Resume Next
...
1240    If outRow > 3 Then
            ...
            MsgBoxU wsMsgSrc.Cells(2, 1).Value & (outRow - 3) & wsMsgSrc.Cells(3, 1).Value, vbInformation
        Else
            ' No issues found - go straight to home
            MsgBoxU wsMsgSrc.Cells(4, 1).Value, vbInformation
...
1360    MsgBoxU wsMsgSrc.Cells(5, 1).Value & errLine & vbCrLf & wsMsgSrc.Cells(6, 1).Value & errNum & vbCrLf & errSrc & vbCrLf & errDesc, vbCritical
...
440     On Error GoTo ERR_HANDLER
        ...
        ChrW(1514) & ChrW(1493) & ChrW(1512) & " 5." & vbCrLf & vbCrLf & _
                ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1500) & ChrW(1492) & ChrW(1512) & ChrW(1497) & ChrW(1509) & " " & ChrW(1513) & ChrW(1493) & ChrW(1489) & "?"
...
2960    MsgBoxU wsMsgSrc2.Cells(5, 1).Value & errLine & vbCrLf & wsMsgSrc2.Cells(6, 1).Value & errNum & vbCrLf & wsMsgSrc2.Cells(7, 1).Value & debugStep & vbCrLf & errSrc & vbCrLf & errDesc, vbCritical
...
90      If periodDetail <> "" Then periodDesc = periodDetail
    ...
    End If
        ...
        ChrW(1493) & ChrW(1512) & " 5." & vbCrLf & vbCrLf & _
                ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1500) & ChrW(1492) & ChrW(1512) & ChrW(1497) & ChrW(1509) & " " & ChrW(1513) & ChrW(1493) & ChrW(1489) & "?"
...
Public Sub NewClients()
    ...
    If SheetExists(NC_MASTER_SHEET_NAME()) Then
        ...
        ChrW(1492) & " " & ChrW(1494) & ChrW(1493) & "." & vbCrLf & vbCrLf & _
            ChrW(1488) & ChrW(1501) & " " & ChrW(1489) & ChrW(1512) & ChrW(1510) & ChrW(1493) & ChrW(1504) & ChrW(1498) & _
        " " & ChrW(1500) & ChrW(1510) & ChrW(1508) & ChrW(1493) & ChrW(1514) & " " & ChrW(1489) & ChrW(1512) & ChrW(1513) & _
        ChrW(1497) & ChrW(1502) & ChrW(1492) & " " & ChrW(1500) & ChrW(1495) & ChrW(1509) & " " & ChrW(1499) & ChrW(1503) & "."
...
NextNCRow:
    ...
    shpHome.OnAction = "A00_SetupMainSheet"
...
Private Function IsProtectedSheet(ByVal sName As String, ByVal refBaseKeep As String, ByVal refBaseKeepOld As String) As Boolean
