Attribute VB_Name = "Goren_Claude_V2_219"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.219"
...
Public Sub SetupInstructionsSheet()
    ...
    Set shp = wsInst.Shapes.AddShape(msoShapeRoundedRectangle, wsInst.Range("A20").Left, wsInst.Range("A20").Top, 250, 40)
