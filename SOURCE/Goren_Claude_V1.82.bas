Attribute VB_Name = "Goren_Claude1_82"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.82"
...
190     End If
        ...
        formulaStr = ""
        On Error Resume Next
        Set rn = ThisWorkbook.Names(listName).RefersToRange
        On Error GoTo ERR_HANDLER
        If Not rn Is Nothing Then
            For Each c In rn
                If Trim$(c.Value) <> "" Then
                    formulaStr = formulaStr & Trim$(c.Value) & ","
                End If
            Next c
            If Len(formulaStr) > 0 Then formulaStr = Left$(formulaStr, Len(formulaStr) - 1)
        End If
        If formulaStr = "" Then GoTo CLEAN_EXIT

200     wsMain.Range("rngPeriodValue").Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:=formulaStr
