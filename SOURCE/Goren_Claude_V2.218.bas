Attribute VB_Name = "Goren_Claude_V2_218"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.218"
...
Public Sub SetupInstructionsSheet()
    ...
    Set shp = wsInst.Shapes.AddShape(msoShapeRoundedRectangle, wsInst.Range("J20").Left, wsInst.Range("J20").Top, 250, 40)
