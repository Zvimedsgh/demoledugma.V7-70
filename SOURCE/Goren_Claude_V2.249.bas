Attribute VB_Name = "Goren_Claude_V2_249"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.249"
...
4902 wsMain.Range("A1:K13").Select
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.249! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
