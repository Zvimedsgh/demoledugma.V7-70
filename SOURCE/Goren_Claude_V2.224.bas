Attribute VB_Name = "Goren_Claude_V2_224"
' ============================================================================
' MODULE: modLevav
...
1110 ThisWorkbook.Names.Add "map_filter", wsTemp.Range("G1:H5")
    ...
    ' Set defaults
    1550 If IsEmpty(wsMain.Range("G3").Value) Then wsMain.Range("G3").Value = 2025
    1560 If IsEmpty(wsMain.Range("G4").Value) Then wsMain.Range("G4").Value = 2026
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.224! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
