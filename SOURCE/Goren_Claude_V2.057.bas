Attribute VB_Name = "Goren_Claude_V2_057"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.057"
Private Const APP_DATE As String = "02/07/2026 11:00"
Private Const FORCE_DEMO_MODE As Boolean = True  ' Set to True. Now controlled by DEMO_MODE in parameters sheet.
...
Public Sub BuildReview()
    MsgBoxU ChrW(1502) & ChrW(1512) & ChrW(1497) & ChrW(1509) & " " & ChrW(1488) & ChrW(1514) & " " & ChrW(1490) & ChrW(1512) & ChrW(1505) & ChrW(1492) & " 2.057!!!", vbInformation
...
wsMain.Range("A1:Z1").UnMerge
wsMain.Range("A1:Z1").ClearContents
    ...
    shtHeaders = Array(ChrW(1502) & ChrW(1497) & ChrW(1508) & ChrW(1493) & ChrW(1497) & " " & ChrW(1513) & ChrW(1491) & ChrW(1493) & ChrW(1514), _
    ...
    For iIdx = 0 To UBound(shtNames)
        ...
        If Err.Number <> 0 Then
            ...
            wsTemp.Name = shtNames(iIdx)
            wsTemp.Cells(1, 1).Value = shtHeaders(iIdx)
            wsTemp.Cells(1, 1).Font.Bold = True
            wsTemp.Cells(1, 1).Font.Size = 14
        End If
        Err.Clear
        On Error GoTo ERR_HANDLER
    Next iIdx
    ...
    ' ---- Period Lists ----
    Set wsTemp = ThisWorkbook.Worksheets(H_SET_PERIODS())
    wsTemp.Range("A2:A50").ClearContents
    wsTemp.Cells(2, 1).Value = "PERIOD_TYPE"
    wsTemp.Cells(3, 1).Value = ChrW(1513) & ChrW(1504) & ChrW(1514) & ChrW(1497)
    wsTemp.Cells(4, 1).Value = ChrW(1495) & ChrW(1510) & ChrW(1497) & " " & ChrW(1513) & ChrW(1504) & ChrW(1514) & ChrW(1497)
    wsTemp.Cells(5, 1).Value = ChrW(1512) & ChrW(1489) & ChrW(1506) & ChrW(1493) & ChrW(1503)
    wsTemp.Cells(6, 1).Value = ChrW(1495) & ChrW(1493) & ChrW(1491) & ChrW(1513) & ChrW(1497)
    wsTemp.Cells(7, 1).Value = "HALF_YEAR"
    wsTemp.Cells(8, 1).Value = ChrW(1502) & ChrW(1495) & ChrW(1510) & ChrW(1497) & ChrW(1514) & " " & ChrW(1512) & ChrW(1488) & ChrW(1513) & ChrW(1493) & ChrW(1504) & ChrW(1492)
    wsTemp.Cells(9, 1).Value = ChrW(1502) & ChrW(1495) & ChrW(1510) & ChrW(1497) & ChrW(1514) & " " & ChrW(1513) & ChrW(1504) & ChrW(1497) & ChrW(1492)
    ...
    Err.Clear
    On Error GoTo ERR_HANDLER
    ThisWorkbook.Names.Add "lst_empty", wsTemp.Range(wsTemp.Cells(50, 1), wsTemp.Cells(50, 1))
ThisWorkbook.Names.Add "lst_period_type", wsTemp.Range(wsTemp.Cells(3, 1), wsTemp.Cells(6, 1))
    ThisWorkbook.Names.Add "lst_half_year", wsTemp.Range(wsTemp.Cells(8, 1), wsTemp.Cells(9, 1))
    
    wsTemp.Cells(11, 1).Value = ChrW(1512) & ChrW(1489) & ChrW(1506) & ChrW(1493) & ChrW(1503) & " " & ChrW(1512) & ChrW(1488) & ChrW(1513) & ChrW(1493) & ChrW(1503)
    wsTemp.Cells(12, 1).Value = ChrW(1512) & ChrW(1489) & ChrW(1506) & ChrW(1493) & ChrW(1503) & " " & ChrW(1513) & ChrW(1504) & ChrW(1497)
    wsTemp.Cells(13, 1).Value = ChrW(1512) & ChrW(1489) & ChrW(1506) & ChrW(1493) & ChrW(1503) & " " & ChrW(1513) & ChrW(1500) & ChrW(1497) & ChrW(1513) & ChrW(1497)
    wsTemp.Cells(14, 1).Value = ChrW(1512) & ChrW(1489) & ChrW(1506) & ChrW(1493) & ChrW(1503) & " " & ChrW(1512) & ChrW(1489) & ChrW(1497) & ChrW(1506) & ChrW(1497)
    ThisWorkbook.Names.Add "lst_quarter", wsTemp.Range(wsTemp.Cells(11, 1), wsTemp.Cells(14, 1))
    
    wsTemp.Cells(16, 1).Value = ChrW(1497) & ChrW(1504) & ChrW(1493) & ChrW(1488) & ChrW(1512)
    wsTemp.Cells(17, 1).Value = ChrW(1508) & ChrW(1489) & ChrW(1512) & ChrW(1493) & ChrW(1488) & ChrW(1512)
    wsTemp.Cells(18, 1).Value = ChrW(1502) & ChrW(1512) & ChrW(1509)
    wsTemp.Cells(19, 1).Value = ChrW(1488) & ChrW(1508) & ChrW(1512) & ChrW(1497) & ChrW(1500)
    wsTemp.Cells(20, 1).Value = ChrW(1502) & ChrW(1488) & ChrW(1497)
    wsTemp.Cells(21, 1).Value = ChrW(1497) & ChrW(1493) & ChrW(1504) & ChrW(1497)
    wsTemp.Cells(22, 1).Value = ChrW(1497) & ChrW(1493) & ChrW(1500) & ChrW(1497)
    wsTemp.Cells(23, 1).Value = ChrW(1488) & ChrW(1493) & ChrW(1490) & ChrW(1493) & ChrW(1505) & ChrW(1496)
    wsTemp.Cells(24, 1).Value = ChrW(1505) & ChrW(1508) & ChrW(1496) & ChrW(1502) & ChrW(1489) & ChrW(1512)
    wsTemp.Cells(25, 1).Value = ChrW(1488) & ChrW(1493) & ChrW(1511) & ChrW(1496) & ChrW(1493) & ChrW(1489) & ChrW(1512)
    wsTemp.Cells(26, 1).Value = ChrW(1504) & ChrW(1493) & ChrW(1489) & ChrW(1502) & ChrW(1489) & ChrW(1512)
    wsTemp.Cells(27, 1).Value = ChrW(1491) & ChrW(1510) & ChrW(1502) & ChrW(1489) & ChrW(1512)
    ThisWorkbook.Names.Add "lst_month", wsTemp.Range(wsTemp.Cells(16, 1), wsTemp.Cells(27, 1))

Dim tHalf As String, tQuarter As String, tMonth As String
tHalf = ChrW(1495) & ChrW(1510) & ChrW(1497) & " " & ChrW(1513) & ChrW(1504) & ChrW(1514) & ChrW(1497)
tQuarter = ChrW(1512) & ChrW(1489) & ChrW(1506) & ChrW(1493) & ChrW(1503)
tMonth = ChrW(1495) & ChrW(1493) & ChrW(1491) & ChrW(1513) & ChrW(1497)
...
ThisWorkbook.Names.Add "map_filter", wsTemp.Range("G1:H5")
    wsTemp.Cells(28, 1).Value = EOD_MARKER
...
If demoParam = ChrW(1500) & ChrW(1488) Or demoParam = "NO" Then isDemoMode = False
    ...
    On Error Resume Next
    wsMain.Range("G5").MergeArea.Validation.Delete
    wsMain.Range("G5").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:="=lst_period_type"
    wsMain.Range("G6").MergeArea.Validation.Delete
    
wsMain.Range("G6").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:="=lst_empty"
    ...
    wsMain.Range("G7").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:=dateTypeList
    ...
    wsMain.Range("G8").MergeArea.Validation.Delete
    ...
    wsMain.Range("G8").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:=filterTypeList
    wsMain.Range("G9").MergeArea.Validation.Delete
    
    Dim tComp As String, tTeller As String, tAgent As String, tBranch As String, tMainBranch As String
    tComp = H_COMPANY(): tTeller = H_TELLER(): tAgent = H_AGENT(): tBranch = H_BRANCH(): tMainBranch = H_BRANCH() & " " & ChrW(1502) & ChrW(1512) & ChrW(1499) & ChrW(1494)
wsMain.Range("G9").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:="=lst_empty"
    Err.Clear
    On Error GoTo ERR_HANDLER
    ...
    wsMain.Columns("G").ColumnWidth = 24
    ...
    wsMain.Range("A1:F1").Merge
    wsMain.Range("A1").Value = GetActiveAgencyName()
    wsMain.Range("A1").Font.Size = 28
    ...
    Set shpExit = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("A19").Left + 60, wsMain.Range("A19").Top, 120, 25)
    ...
    wsMain.Range("F19").Value = ChrW(1504) & ChrW(1489) & ChrW(1504) & ChrW(1492) & " " & ChrW(1506) & ChrW(1500) & " " & ChrW(1497) & ChrW(1491) & ChrW(1497) & " " & ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " 054-6677396 - v" & APP_VERSION
        wsMain.Range("F19").Font.Size = 12
    wsMain.Range("F19").Font.Color = RGB(0, 0, 0)
    wsMain.Range("F19").Font.Bold = True
    wsMain.Range("F19").HorizontalAlignment = -4108
...
1800  wsTemp.Cells(2, 1).Value = ChrW(1492) & ChrW(1505) & ChrW(1514) & ChrW(1497) & ChrW(1497) & ChrW(1501) & " " & "-" & " " & ChrW(1504) & ChrW(1502) & ChrW(1510) & ChrW(1488) & ChrW(1493) & " "
1810  wsTemp.Cells(3, 1).Value = " " & ChrW(1495) & ChrW(1512) & ChrW(1497) & ChrW(1490) & ChrW(1493) & ChrW(1514)
1820  wsTemp.Cells(4, 1).Value = ChrW(1492) & ChrW(1505) & ChrW(1514) & ChrW(1497) & ChrW(1497) & ChrW(1501) & " " & ChrW(1489) & ChrW(1492) & ChrW(1510) & ChrW(1500) & ChrW(1495) & ChrW(1492)
1830  wsTemp.Cells(5, 1).Value = ChrW(1513) & ChrW(1493) & ChrW(1512) & ChrW(1492) & " "
1840  wsTemp.Cells(6, 1).Value = ChrW(1513) & ChrW(1490) & ChrW(1497) & ChrW(1488) & ChrW(1492) & " "
1850  wsTemp.Cells(7, 1).Value = ChrW(1513) & ChrW(1500) & ChrW(1489) & ":" & " "
1860  wsTemp.Cells(8, 1).Value = ChrW(1488) & ChrW(1497) & ChrW(1513) & ChrW(1493) & ChrW(1512) & " " & ChrW(1500) & ChrW(1508) & ChrW(1504) & ChrW(1497) & " " & ChrW(1506) & ChrW(1497) & ChrW(1489) & ChrW(1493) & ChrW(1491)
1870  wsTemp.Cells(9, 1).Value = ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1500) & ChrW(1497) & ChrW(1497) & ChrW(1513) & ChrW(1501) & " " & ChrW(1514) & ChrW(1497) & ChrW(1511) & ChrW(1493) & ChrW(1504) & ChrW(1497) & ChrW(1501) & " " & ChrW(1493) & ChrW(1500) & ChrW(1497) & ChrW(1497) & ChrW(1510) & ChrW(1512) & " " & ChrW(1491) & ChrW(1493) & ChrW(1495) & ChrW(1493) & ChrW(1514) & "?"
1880  wsTemp.Cells(10, 1).Value = ChrW(1513) & ChrW(1490) & ChrW(1497) & ChrW(1488) & ChrW(1492) & " " & ChrW(1489) & ChrW(1492) & ChrW(1490) & ChrW(1491) & ChrW(1512) & ChrW(1514) & " " & ChrW(1491) & ChrW(1507) & " " & ChrW(1492) & ChrW(1489) & ChrW(1497) & ChrW(1514) & ":" & " "
1890  wsTemp.Cells(11, 1).Value = ChrW(1513) & ChrW(1490) & ChrW(1497) & ChrW(1488) & ChrW(1492) & " " & ChrW(1489) & ChrW(1506) & ChrW(1491) & ChrW(1499) & ChrW(1493) & ChrW(1503) & " " & ChrW(1514) & ChrW(1511) & ChrW(1493) & ChrW(1508) & ChrW(1492) & ":" & " "
1900  wsTemp.Cells(12, 1).Value = ChrW(1490) & ChrW(1497) & ChrW(1500) & ChrW(1497) & ChrW(1493) & ChrW(1503) & " " & ChrW(1491) & ChrW(1507) & " " & ChrW(1492) & ChrW(1489) & ChrW(1497) & ChrW(1514) & " " & ChrW(1492) & ChrW(1493) & ChrW(1511) & ChrW(1501) & " " & ChrW(1489) & ChrW(1492) & ChrW(1510) & ChrW(1500) & ChrW(1495) & ChrW(1492) & "!"
1910  wsTemp.Cells(13, 1).Value = "1" & "." & " " & ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1492) & ChrW(1506) & ChrW(1500) & ChrW(1497) & ChrW(1514) & " " & ChrW(1511) & ChrW(1493) & ChrW(1489) & ChrW(1509) & " " & ChrW(1513) & ChrW(1500) & ChrW(1497) & ChrW(1508) & ChrW(1492) & " " & ChrW(1506) & ChrW(1491) & ChrW(1499) & ChrW(1504) & ChrW(1497) & "?"
1920  wsTemp.Cells(14, 1).Value = "2" & "." & " " & ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1513) & ChrW(1502) & ChrW(1512) & ChrW(1514) & " " & ChrW(1488) & ChrW(1514) & " " & ChrW(1492) & ChrW(1506) & ChrW(1497) & ChrW(1489) & ChrW(1493) & ChrW(1491) & " " & ChrW(1492) & ChrW(1488) & ChrW(1495) & ChrW(1512) & ChrW(1493) & ChrW(1503) & " " & "(" & ChrW(1492) & ChrW(1504) & ChrW(1514) & ChrW(1493) & ChrW(1504) & ChrW(1497) & ChrW(1501) & " " & ChrW(1489) & ChrW(1495) & ChrW(1493) & ChrW(1489) & ChrW(1512) & ChrW(1514) & " " & ChrW(1494) & ChrW(1493) & " " & ChrW(1497) & ChrW(1502) & ChrW(1495) & ChrW(1511) & ChrW(1493) & " " & ChrW(1489) & ChrW(1514) & ChrW(1492) & ChrW(1500) & ChrW(1497) & ChrW(1498) & " " & ChrW(1492) & ChrW(1506) & ChrW(1497) & ChrW(1489) & ChrW(1493) & ChrW(1491) & ")"
1930  wsTemp.Cells(15, 1).Value = "3" & "." & " " & ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1489) & ChrW(1495) & ChrW(1512) & ChrW(1514) & " " & ChrW(1488) & ChrW(1514) & " " & ChrW(1508) & ChrW(1512) & ChrW(1496) & ChrW(1497) & " " & ChrW(1492) & ChrW(1506) & ChrW(1497) & ChrW(1489) & ChrW(1493) & ChrW(1491) & " " & ChrW(1492) & ChrW(1504) & ChrW(1491) & ChrW(1512) & ChrW(1513) & " " & ChrW(1489) & ChrW(1490) & ChrW(1497) & ChrW(1500) & ChrW(1497) & ChrW(1493) & ChrW(1503) & " " & ChrW(1491) & ChrW(1507) & " " & ChrW(1492) & ChrW(1489) & ChrW(1497) & ChrW(1514) & "?"
1940  wsTemp.Cells(16, 1).Value = "4" & "." & " " & ChrW(1500) & ChrW(1495) & ChrW(1509) & " " & ChrW(1506) & ChrW(1500) & " " & "O" & "K" & " " & ChrW(1500) & ChrW(1492) & ChrW(1502) & ChrW(1513) & ChrW(1498)
1950  wsTemp.Cells(17, 1).Value = ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1500) & ChrW(1492) & ChrW(1510) & ChrW(1497) & ChrW(1490) & " " & ChrW(1492) & ChrW(1493) & ChrW(1491) & ChrW(1506) & ChrW(1492) & " " & ChrW(1494) & ChrW(1493) & " " & ChrW(1513) & ChrW(1493) & ChrW(1489) & "?"
      wsTemp.Cells(18, 1).Value = EOD_MARKER
...
1965  paramLastRow = paramStartRow
      Do While UCase$(Trim$(CStr(wsParams.Cells(paramLastRow, COL_PARAM_NAME).Value2))) <> EOD_MARKER _
...
1990  If UCase$(Trim$(CStr(wsParams.Cells(pr, COL_PARAM_NAME).Value2))) = "ERROR_EMAIL" Then foundEmail = True: Exit For
2000  Next pr
2010  If Not foundEmail Then
2020  wsParams.Cells(paramLastRow + 1, COL_PARAM_NAME).Value = "ERROR_EMAIL"
2030  wsParams.Cells(paramLastRow + 1, COL_PARAM_VALUE).Value = "zvi@gorentech.co.il"
...
2050  End If
      ...
      For pr = paramStartRow To paramLastRow
          If UCase$(Trim$(CStr(wsParams.Cells(pr, COL_PARAM_NAME).Value2))) = "DEMO_MODE" Then foundDemo = True: Exit For
      Next pr
      If Not foundDemo Then
          wsParams.Cells(paramLastRow + 1, COL_PARAM_NAME).Value = "DEMO_MODE"
wsParams.Cells(paramLastRow + 1, COL_PARAM_VALUE).Value = ChrW(1499) & ChrW(1503) ' YES
          paramLastRow = paramLastRow + 1
      End If
...
2080  If UCase$(Trim$(CStr(wsParams.Cells(pr, COL_PARAM_NAME).Value2))) = "BACKUP_PATH" Then foundBackup = True: Exit For
2090  Next pr
2100  If Not foundBackup Then
2110  wsParams.Cells(paramLastRow + 1, COL_PARAM_NAME).Value = "BACKUP_PATH"
2120  wsParams.Cells(paramLastRow + 1, COL_PARAM_VALUE).Value = "C:\LEVAV PROJECT\BACKUPS"
2130  End If
End If ' End If Not wsParams Is Nothing
...
4080  ResetHomeDefaults
4085  Application.EnableEvents = True
...
4130  If Err.Number <> 0 Then
            On Error Resume Next
4140  MsgBoxU ThisWorkbook.Worksheets(H_SET_MESSAGES()).Cells(10, 1).Value & Err.Description & " (Line: " & Erl & ")", vbCritical
4150  End If
...
92      ReDim arrCommC(1 To nItems)
        ...
        Dim idx As Long
70 idx = 0
80 For r = 4 To lastRow - 1
90 tmpName = ShortenCompanyName(Trim$(CStr(ws.Cells(r, 1).Value2)))
            ' Skip excluded name (for "agents without Levav" variant)
100 If Len(excludeName) > 0 Then
110 If InStr(1, tmpName, excludeName, vbTextCompare) > 0 Then GoTo NEXT_ROW_ECC
120 End If
130 idx = idx + 1
140 If idx > nItems Then Exit For
150 arrNames(idx) = tmpName
160 arrPremR(idx) = CDbl(ws.Cells(r, 2).Value2)
170 arrPremC(idx) = CDbl(ws.Cells(r, 3).Value2)
180 arrDocsR(idx) = CDbl(ws.Cells(r, 5).Value2)
190 arrDocsC(idx) = CDbl(ws.Cells(r, 6).Value2)
200 arrInsR(idx) = CDbl(ws.Cells(r, 8).Value2)
210 arrInsC(idx) = CDbl(ws.Cells(r, 9).Value2)
...
270 chartItems = nItems
280 If chartItems = 0 Then
290 Application.ScreenUpdating = True
300 Exit Sub
310 End If
320 If chartItems > 15 Then chartItems = 15

        Dim tmpWs As Worksheet
        Dim co As Object
        Dim xlCht As Object
        Dim ci As Long
330 Application.ScreenUpdating = False
340 Set tmpWs = ThisWorkbook.Worksheets.Add

        ' ---- Chart 1: Premiums ----
350 tmpWs.Cells(1, 1).Value = ""
360 tmpWs.Cells(1, 2).Value = refYear
370 tmpWs.Cells(1, 3).Value = yearVal
380 For ci = 1 To chartItems
390 tmpWs.Cells(ci + 1, 1).Value = arrNames(ci)
400 tmpWs.Cells(ci + 1, 2).Value = arrPremR(ci)
410 tmpWs.Cells(ci + 1, 3).Value = arrPremC(ci)
420 Next ci

430 Set co = tmpWs.ChartObjects.Add(10, 10, 600, 350)
440 Set xlCht = co.Chart
450 xlCht.ChartType = 51
460 xlCht.SetSourceData tmpWs.Range(tmpWs.Cells(1, 1), tmpWs.Cells(chartItems + 1, 3)), 2  ' xlColumns
470 xlCht.HasTitle = False
480 xlCht.HasLegend = True

        ' --- Colors: Yellow=ref year, Blue=current year ---
490 xlCht.SeriesCollection(1).Format.Fill.ForeColor.RGB = RGB(255, 192, 0)     ' yellow/gold
500 xlCht.SeriesCollection(2).Format.Fill.ForeColor.RGB = RGB(68, 114, 196)    ' blue

        ' --- Data labels (show in K, vertical/upward) ---
        Dim sP As Long
510 For sP = 1 To 2
520 xlCht.SeriesCollection(sP).HasDataLabels = True
530 xlCht.SeriesCollection(sP).DataLabels.NumberFormat = "#,##0,""K"""
540 xlCht.SeriesCollection(sP).DataLabels.Font.Size = 9
550 xlCht.SeriesCollection(sP).DataLabels.Orientation = 90
560 Next sP

        ' --- Y-axis number format (in K) ---
570 xlCht.Axes(2).TickLabels.NumberFormat = "#,##0,""K"""

580 xlCht.Export imgPrem

        On Error Resume Next
590 tmpWs.ChartObjects.Delete
        On Error GoTo ERR_HANDLER
600 tmpWs.Cells.Clear

        ' ---- Chart 2: Commissions ----
610 tmpWs.Cells(1, 1).Value = ""
620 tmpWs.Cells(1, 2).Value = refYear
630 tmpWs.Cells(1, 3).Value = yearVal
640 For ci = 1 To chartItems
650 tmpWs.Cells(ci + 1, 1).Value = arrNames(ci)
660 tmpWs.Cells(ci + 1, 2).Value = arrCommR(ci)
670 tmpWs.Cells(ci + 1, 3).Value = arrCommC(ci)
680 Next ci

690 Set co = tmpWs.ChartObjects.Add(10, 10, 600, 350)
700 Set xlCht = co.Chart
710 xlCht.ChartType = 51
720 xlCht.SetSourceData tmpWs.Range(tmpWs.Cells(1, 1), tmpWs.Cells(chartItems + 1, 3)), 2  ' xlColumns
730 xlCht.HasTitle = False
740 xlCht.HasLegend = True

        ' --- Colors: Orange=ref year, Green=current year ---
750 xlCht.SeriesCollection(1).Format.Fill.ForeColor.RGB = RGB(237, 125, 49)    ' orange
760 xlCht.SeriesCollection(2).Format.Fill.ForeColor.RGB = RGB(112, 173, 71)    ' green

        ' --- Data labels (show in K, vertical/upward) ---
        Dim sC As Long
770 For sC = 1 To 2
780 xlCht.SeriesCollection(sC).HasDataLabels = True
790 xlCht.SeriesCollection(sC).DataLabels.NumberFormat = "#,##0,""K"""
800 xlCht.SeriesCollection(sC).DataLabels.Font.Size = 9
810 xlCht.SeriesCollection(sC).DataLabels.Orientation = 90
820 Next sC

        ' --- Y-axis number format (in K) ---
830 xlCht.Axes(2).TickLabels.NumberFormat = "#,##0,""K"""

840 xlCht.Export imgComm

        ' ---- Chart 3: Documents (optional) ----
850 If imgDocs <> "" Then
        On Error Resume Next
860 tmpWs.ChartObjects.Delete
        On Error GoTo ERR_HANDLER
870 tmpWs.Cells.Clear
880 tmpWs.Cells(1, 1).Value = ""
890 tmpWs.Cells(1, 2).Value = refYear
900 tmpWs.Cells(1, 3).Value = yearVal
910 For ci = 1 To chartItems
920 tmpWs.Cells(ci + 1, 1).Value = arrNames(ci)
930 tmpWs.Cells(ci + 1, 2).Value = arrDocsR(ci)
940 tmpWs.Cells(ci + 1, 3).Value = arrDocsC(ci)
950 Next ci
960 Set co = tmpWs.ChartObjects.Add(10, 10, 600, 350)
970 Set xlCht = co.Chart
980 xlCht.ChartType = 51
990 xlCht.SetSourceData tmpWs.Range(tmpWs.Cells(1, 1), tmpWs.Cells(chartItems + 1, 3)), 2
1000 xlCht.HasTitle = False
1010 xlCht.HasLegend = True
1020 xlCht.SeriesCollection(1).Format.Fill.ForeColor.RGB = RGB(180, 130, 70)    ' brown/tan
1030 xlCht.SeriesCollection(2).Format.Fill.ForeColor.RGB = RGB(91, 155, 213)    ' steel blue
            Dim sD As Long
1040 For sD = 1 To 2
1050 xlCht.SeriesCollection(sD).HasDataLabels = True
1060 xlCht.SeriesCollection(sD).DataLabels.NumberFormat = "#,##0"
1070 xlCht.SeriesCollection(sD).DataLabels.Font.Size = 9
1080 xlCht.SeriesCollection(sD).DataLabels.Orientation = 90
1090 Next sD
1100 xlCht.Axes(2).TickLabels.NumberFormat = "#,##0"
1110 xlCht.Export imgDocs
1120 End If

        ' ---- Chart 4: Insured persons (optional) ----
1130 If imgInsured <> "" Then
        On Error Resume Next
1140 tmpWs.ChartObjects.Delete
        On Error GoTo ERR_HANDLER
1150 tmpWs.Cells.Clear
1160 tmpWs.Cells(1, 1).Value = ""
1170 tmpWs.Cells(1, 2).Value = refYear
1180 tmpWs.Cells(1, 3).Value = yearVal
1190 For ci = 1 To chartItems
1200 tmpWs.Cells(ci + 1, 1).Value = arrNames(ci)
1210 tmpWs.Cells(ci + 1, 2).Value = arrInsR(ci)
1220 tmpWs.Cells(ci + 1, 3).Value = arrInsC(ci)
1230 Next ci
1240 Set co = tmpWs.ChartObjects.Add(10, 10, 600, 350)
1250 Set xlCht = co.Chart
1260 xlCht.ChartType = 51
1270 xlCht.SetSourceData tmpWs.Range(tmpWs.Cells(1, 1), tmpWs.Cells(chartItems + 1, 3)), 2
1280 xlCht.HasTitle = False
1290 xlCht.HasLegend = True
1300 xlCht.SeriesCollection(1).Format.Fill.ForeColor.RGB = RGB(128, 0, 128)     ' purple
1310 xlCht.SeriesCollection(2).Format.Fill.ForeColor.RGB = RGB(0, 176, 80)      ' green
            Dim si As Long
1320 For si = 1 To 2
1330 xlCht.SeriesCollection(si).HasDataLabels = True
1340 xlCht.SeriesCollection(si).DataLabels.NumberFormat = "#,##0"
1350 xlCht.SeriesCollection(si).DataLabels.Font.Size = 9
1360 xlCht.SeriesCollection(si).DataLabels.Orientation = 90
1370 Next si
1380 xlCht.Axes(2).TickLabels.NumberFormat = "#,##0"
1390 xlCht.Export imgInsured
1400 End If

1410 Application.DisplayAlerts = False
1420 tmpWs.Delete
1430 Application.DisplayAlerts = True

1440 Exit Sub
1450 ERR_HANDLER:
1460 Application.EnableEvents = True
1470 Application.DisplayAlerts = True
620     On Error Resume Next
1480 Application.DisplayAlerts = False
1490 If Not tmpWs Is Nothing Then tmpWs.Delete
1500 Application.DisplayAlerts = True
1510 Err.Raise Err.Number, "ExportCompCharts(" & sheetName & "):" & Erl, Err.Description
End Sub
...
Private Function IsProtectedSheet(ByVal sName As String, ByVal refBaseKeep As String, ByVal refBaseKeepOld As String) As Boolean
    ...
    If InStr(1, UCase$(sName), "DATA") > 0 Then IsProtectedSheet = True: Exit Function
