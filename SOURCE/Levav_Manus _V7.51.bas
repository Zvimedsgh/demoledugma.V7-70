Attribute VB_Name = "Levav_Manus_V7_51"
' ============================================================================
' MODULE: modLevav
...
2785    On Error Resume Next
        With ThisWorkbook.Worksheets(CONTROL_SHEET_NAME()).Range("G15")
            .Value = ""
...
894     shp.OnAction = "BuildPresentation"
        ...
        ' Button: Show/Hide hidden sheets - placed at P12
        Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("P12").Left, wsMain.Range("P12").Top, 160, 30)
...
880     Next pg
        ...
        reportsFolder = ThisWorkbook.Path & "\Reports"
        If Not fsoRpt.FolderExists(reportsFolder) Then fsoRpt.CreateFolder reportsFolder
        
        Dim savePath As String
890     savePath = reportsFolder & "\" & ChrW(1502) & ChrW(1510) & ChrW(1490) & ChrW(1514) & " " & ChrW(1492) & ChrW(1504) & ChrW(1492) & ChrW(1500) & ChrW(1492) & " " & yearVal & ".pptx"
...
1010    With wsMain.Range("G15")
1020        .Value = ""
1030        .Interior.Color = RGB(220, 240, 220)
1040    End With

        ' Success message (simple, no paths)
        ' "hamatzget notzra behatzlacha!" = The presentation was created successfully!
1050    MsgBoxU ChrW(1492) & ChrW(1502) & ChrW(1510) & ChrW(1490) & ChrW(1514) & " " & ChrW(1504) & ChrW(1493) & ChrW(1510) & ChrW(1512) & ChrW(1492) & " " & ChrW(1489) & ChrW(1492) & ChrW(1510) & ChrW(1500) & ChrW(1495) & ChrW(1492) & "!", vbInformation
