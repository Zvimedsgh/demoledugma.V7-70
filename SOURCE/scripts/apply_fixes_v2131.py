...
# I will find the Explanation text block and move it before the button block.
...
btn_block = """' Add "Search" button
Dim btnLeft As Double, btnTop As Double
btnLeft = wsSearch.Cells(2, 2).Left + 10"""

if expl_block in content and btn_block in content:
...
# Also update the A00_SetupMainSheet demo message
...
if target_setup in content:
    ...
    print("Replaced A00_SetupMainSheet demo msg.")
