...
filepath_in = r'c:\LEVAV PROJECT\SOURCE\Goren_Claude_V2.164.bas'
filepath_out = r'c:\LEVAV PROJECT\SOURCE\Goren_Claude_V2.165.bas'

with open(filepath_in, 'r', encoding='utf-8') as f:
    content = f.read()

# Update version
content = content.replace('Attribute VB_Name = "Goren_Claude_V2_164"', 'Attribute VB_Name = "Goren_Claude_V2_165"')
content = content.replace('VERSION: V2.164', 'VERSION: V2.165')
content = content.replace('APP_VERSION As String = "2.164"', 'APP_VERSION As String = "2.165"')

# Fix Demo message - replacing the Shape logic with Range logic
...
3687 shpDemoMsg.TextFrame2.TextRange.Text = ChrW(1500) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & " " & ChrW(1493) & ChrW(1492) & ChrW(1491) & ChrW(1512) & ChrW(1499) & ChrW(1492) & " " & ChrW(1513) & ChrW(1500) & ChrW(1495) & " WhatsApp " & ChrW(1500) & ChrW(1496) & ChrW(1500) & ChrW(1508) & ChrW(1493) & ChrW(1503) & ": " & ChrW(8207) & "054-6677396"
...
# And replacing the delete logic for real mode
old_block_real = """    On Error Resume Next
    wsMain.Shapes("shpDemoMsgText").Delete
    On Error GoTo ERR_HANDLER
    1760 With wsMain.Range("G3:G4").Validation"""

new_block_real = """    On Error Resume Next
    wsMain.Shapes("shpDemoMsgText").Delete
...
content = content.replace(old_block_real, new_block_real)

with open(filepath_out, 'w', encoding='utf-8') as f:
    f.write(content)

print("Created V2.165 correctly!")
