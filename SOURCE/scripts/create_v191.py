...
filepath_out = r'c:\LEVAV PROJECT\SOURCE\Goren_Claude_V2.191.bas'

with open(filepath_in, 'r', encoding='utf-8') as f:
    content = f.read()

# 1. Update CreateInstructionSheets text and activate Install sheet at the end
# We need to find the `CreateInstructionSheets` implementation and replace it entirely for safety.
...
content = content.replace('Attribute VB_Name = "Goren_Claude_V2_190"', 'Attribute VB_Name = "Goren_Claude_V2_191"')
content = content.replace('VERSION: V2.190', 'VERSION: V2.191')
content = content.replace('APP_VERSION As String = "2.190"', 'APP_VERSION As String = "2.191"')

with open(filepath_out, 'w', encoding='utf-8') as f:
    f.write(content)

print("Created V2.191 correctly!")
