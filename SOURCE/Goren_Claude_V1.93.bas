Attribute VB_Name = "Goren_Claude1_93"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.93"
...
1040    debugStep = "CHECK_SRC"
        ...
        On Error GoTo ERR_HANDLER
        If Not testWs Is Nothing Then isDemoMode = True
...
1090        Set wsSrc = OpenDataSheet(wbSrc)
    ...
    BuildBaseSheet wsSrc, wsBase, baseSheetName, _
        ...
        On Error GoTo ERR_HANDLER
        If Not testRefWs Is Nothing Then isRefDemoMode = True
