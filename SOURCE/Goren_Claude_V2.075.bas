Attribute VB_Name = "Goren_Claude_V2_075"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.075"
...
1570 isDemoMode = FORCE_DEMO_MODE
    ...
    1650 If isDemoMode Then
        ...
        1681 With wsMain.Range("G3:G4").Validation
            1690 .Delete
        1700 .Add Type:=xlValidateCustom, AlertStyle:=xlValidAlertStop, Formula1:="=0"
        1705 .ErrorTitle = ChrW(1513) & ChrW(1490) & ChrW(1497) & ChrW(1488) & ChrW(1492)
            1710 .ErrorMessage = ChrW(1513) & ChrW(1497) & ChrW(1504) & ChrW(1493) & ChrW(1497) & " " & ChrW(1488) & ChrW(1508) & ChrW(1513) & ChrW(1512) & ChrW(1497) & " " & ChrW(1489) & ChrW(1490) & ChrW(1512) & ChrW(1505) & ChrW(1492) & " " & ChrW(1492) & ChrW(1502) & ChrW(1500) & ChrW(1488) & ChrW(1492) & "."
            1720 .ShowError = True
        1730 End With
        1731 On Error GoTo ERR_HANDLER
        1740 wsMain.Range("G3:G4").Interior.Color = RGB(230, 230, 230) ' Gray out visually
    1750 Else
    1760 With wsMain.Range("G3:G4").Validation
        1770 .Delete
        1780 .Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Operator:=xlBetween, Formula1:="=lst_years"
