Attribute VB_Name = "Goren_Claude_V2_259"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.259"
...
330 wsMain.Range("A1:Z1").UnMerge
...
1750 Else
    ...
    1810 End With
        1820 wsMain.Range("G3:G4").Interior.Color = xlNone
    1830 End If
...
1910 wsMain.Range("G6").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:="=lst_empty"
    ...
    1940 wsMain.Range("G7").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:=dateTypeList
        1950 wsMain.Range("G7").Value = ChrW(1489) & ChrW(1493) & ChrW(1512) & ChrW(1491) & ChrW(1512) & ChrW(1493)
    1960 wsMain.Range("G8").Value = ChrW(1489) & ChrW(1495) & ChrW(1512) & "/" & ChrW(1497)
...
2020 wsMain.Range("G9").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:="=lst_empty"
    ...
    2050 wsMain.Range("F12").Value = ChrW(1502) & ChrW(1496) & ChrW(1489) & ChrW(1506)
    2060 wsMain.Range("G12").Value = ChrW(1513) & ChrW(1506) & ChrW(1512)
    2070 wsMain.Range("F12:G12").Interior.Color = RGB(0, 100, 0)
    2080 wsMain.Range("F12:G12").Font.Color = RGB(255, 255, 255)
    2090 wsMain.Range("F12:G12").Font.Bold = True
    2100 wsMain.Range("F12:G12").Font.Size = 12
    2110 wsMain.Range("F12:G12").HorizontalAlignment = xlCenter
    2120 wsMain.Range("F13").Value = "$" & " " & ChrW(1491) & ChrW(1493) & ChrW(1500) & ChrW(1512)
    2130 wsMain.Range("F14").Value = ChrW(8364) & " " & ChrW(1488) & ChrW(1497) & ChrW(1512) & ChrW(1493)
    2140 wsMain.Range("F13:F14").Font.Bold = True
    2150 wsMain.Range("G13:G14").HorizontalAlignment = xlCenter
    2160 wsMain.Range("F13:F14").Interior.Color = RGB(200, 230, 255)
    2170 wsMain.Range("G13:G14").Interior.Color = RGB(255, 245, 230)
    
    2180 On Error Resume Next
    2190 ThisWorkbook.Names("rngDOLAR").Delete
    2200 Err.Clear
    2210 On Error GoTo ERR_HANDLER
    2220 ThisWorkbook.Names.Add "rngDOLAR", wsMain.Range("G13")
    
    2230 curRate = FetchBOIRate()
    2240 If curRate > 0 Then
        2250 wsMain.Range("G13").Value = curRate
    2260 ElseIf IsEmpty(wsMain.Range("G13").Value) Then
        2270 wsMain.Range("G13").Value = 3.002
    2280 End If
    2290 wsMain.Range("G13").NumberFormat = "0.0000"
    
    2300 eurRate = FetchBOIMonthlyAvg("EUR", "")
    2310 If eurRate > 0 Then
        2320 wsMain.Range("G14").Value = eurRate
    2330 ElseIf IsEmpty(wsMain.Range("G14").Value) Then
        2340 wsMain.Range("G14").Value = 3.4239
    2350 End If
    2360 wsMain.Range("G14").NumberFormat = "0.0000"
    2370 wsMain.Range("G13:G14").HorizontalAlignment = xlCenter
    ...
    2390 wsMain.Range("H12:J14").UnMerge
    2400 wsMain.Range("H12:I14").ClearContents
    2410 wsMain.Range("H12").Value = matachMsg
    2420 wsMain.Range("H12:I14").Merge
    2430 wsMain.Range("H12").WrapText = True
    2440 wsMain.Range("H12").Font.Size = 11
    2450 wsMain.Range("H12").Font.Color = RGB(0, 70, 140)
    2460 wsMain.Range("H12").ShrinkToFit = False
    2470 wsMain.Range("H12").VerticalAlignment = xlCenter
    2480 wsMain.Range("H12").HorizontalAlignment = xlCenter
    2490 wsMain.Range("H12:I14").Interior.Color = RGB(220, 230, 255)
    ...
    2710 For Each cellBorder In wsMain.Range("F12:G14")
    ...
    2780 wsMain.Range("H12:I14").BorderAround LineStyle:=xlContinuous, Weight:=xlThin, Color:=RGB(0, 70, 140)
...
3680 btnReset.Name = "btnResetDefaults"
    ...
    3760 Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("A14").Left + 10, wsMain.Range("A14").Top, 140, 30)
    3770 shp.Name = "btnShowHidden"
    3780 shp.Fill.ForeColor.RGB = RGB(80, 80, 80)
    3790 shp.TextFrame2.TextRange.Text = ChrW(1492) & ChrW(1510) & ChrW(1490) & "/" & ChrW(1492) & ChrW(1505) & _
    ...
    3890 shpExit.Name = "btnNavExit"
    3900 shpExit.Fill.ForeColor.RGB = RGB(180, 0, 0)
    3910 shpExit.TextFrame2.TextRange.Text = ChrW(1497) & ChrW(1510) & ChrW(1497) & ChrW(1488) & ChrW(1492) & " " & _
        ChrW(1502) & ChrW(1492) & ChrW(1502) & ChrW(1506) & ChrW(1512) & ChrW(1499) & ChrW(1514)
    3920 shpExit.TextFrame2.TextRange.Font.Fill.ForeColor.RGB = RGB(255, 255, 255)
    3930 shpExit.TextFrame2.TextRange.Font.Size = 10
    3940 shpExit.TextFrame2.TextRange.Font.Bold = msoTrue
    3950 shpExit.TextFrame2.TextRange.ParagraphFormat.Alignment = msoAlignCenter
    3960 shpExit.OnAction = "ExitSystem"

    ' ---- Write Credit Text to F20 ----
' 3970 wsMain.Range("F19").ClearContents
3975 wsMain.Range("A16").Value = ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " v" & APP_VERSION
3980 wsMain.Range("A16").Font.Size = 10
3990 wsMain.Range("A16").Font.Color = RGB(150, 150, 150)
4000 wsMain.Range("A16").Font.Bold = False
4010 wsMain.Range("A16").HorizontalAlignment = -4108
...
4793 With wsMain.Range("D16:I16")
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.259! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
...
Public Sub ApplyDemoLockOnOpen()
    ...
    Set shpManual = wsMain.Shapes.AddShape(msoShapeOval, wsMain.Range("A12").Left + 10, wsMain.Range("A12").Top, 100, 40)
    ...
    wsMain.Range("A16").Value = ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " v" & APP_VERSION
    wsMain.Range("A16").Font.Size = 10
    wsMain.Range("A16").Font.Color = RGB(150, 150, 150)
...
Public Sub CheckUserPermissions()
    ...
    If accessLevel = fullAccess Or UCase$(accessLevel) = "FULLACCESS" Then
...
Next ws
    ...
    wsMainUI.Range("A1").Formula = "=GetActiveAgencyName()"
    ...
    ApplyDemoLockOnOpen
    Application.Goto wsMainUI.Range("G10")
