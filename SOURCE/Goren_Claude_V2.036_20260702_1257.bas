...
Private Const APP_VERSION As String = "2.035"
...
936                 outRow = outRow + 1
                    ...
                    brEndRow = 1 - 1
                    On Error GoTo ERR_HANDLER
                    If brEndRow < 3 Then brEndRow = wsMgmt.Cells(wsMgmt.Rows.Count, 1).End(xlUp).Row
                    brLastRow = brEndRow
                    While Trim$(CStr(wsMgmt.Cells(brLastRow, 1).Value2)) = "" And brLastRow > 3
                    ...
                    If Not brExists Then
                        ...
                        If brLastRow > brEndRow Then
                            wsMgmt.Rows(brEndRow).Insert Shift:=xlDown
                            brLastRow = brEndRow
                        End If
...
2050  End If
      ...
      If Not foundDemo Then
          ...
          wsMgmt.Cells(paramLastRow + 1, COL_PARAM_VALUE).Value = ChrW(1500) & ChrW(1488) 'לא
          paramLastRow = paramLastRow + 1
      End If
