Attribute VB_Name = "Goren_Claude_V2_072"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.072"
...
wsMain.Range("A1:Z1").ClearContents
    ...
    Dim shpBtn As Shape
    For Each shpBtn In wsMain.Shapes
        If shpBtn.Type = 5 Then ' msoShapeRoundedRectangle
            shpBtn.Delete
        End If
    Next shpBtn
