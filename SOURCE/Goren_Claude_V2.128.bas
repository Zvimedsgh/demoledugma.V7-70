...
1740 wsMain.Range("G3:G4").Interior.Color = RGB(230, 230, 230) ' Gray out visually
    ...
    Set shpDemoMsg = wsMain.Shapes.AddTextbox(1, wsMain.Range("D15").Left, wsMain.Range("D15").Top, 350, 40)
...
3680 btnReset.Name = "btnResetDefaults"
    ...
    3970 wsMain.Range("F19").Value = ChrW(1504) & ChrW(1489) & ChrW(1504) & ChrW(1492) & " " & ChrW(1506) & ChrW(1500) & " " & ChrW(1497) & ChrW(1491) & ChrW(1497) & " " & ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " 054-6677396 - v" & APP_VERSION
...
Set shpDemoMsg = wsMain.Shapes.AddTextbox(1, wsMain.Range("D15").Left, wsMain.Range("D15").Top, 500, 40)
shpDemoMsg.Name = "shpDemoMsgText"
shpDemoMsg.TextFrame2.TextRange.Text = ChrW(1500) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & " " & ChrW(1493) & ChrW(1492) & ChrW(1491) & ChrW(1512) & ChrW(1499) & ChrW(1492) & " " & ChrW(1513) & ChrW(1500) & ChrW(1495) & " Whatsapp " & ChrW(1500) & " - 054-6677396"
shpDemoMsg.TextFrame2.TextRange.Font.Size = 17
shpDemoMsg.TextFrame2.TextRange.Font.Bold = -1
