Attribute VB_Name = "Goren_Claude1.33"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.33"
...
320  lblSugTaarih = ChrW(1505) & ChrW(1493) & ChrW(1490) & " " & ChrW(1514) & ChrW(1488) & ChrW(1512) & ChrW(1497) & ChrW(1498)
    ...
    ' ---- Formatting Columns ----
    wsMain.Columns("A").ColumnWidth = 50
    ...
    ' Show/Hide Sheets in M21
    Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("M21").Left, wsMain.Range("M21").Top, 160, 30)
    ...
    ' ---- Add Credit and Version to A21 ----
    wsMain.Range("A20:Z30").ClearContents
    wsMain.Range("A21").Value = ChrW(1504) & ChrW(1489) & ChrW(1504) & ChrW(1492) & " " & ChrW(1506) & ChrW(1500) & " " & ChrW(1497) & ChrW(1491) & ChrW(1497) & " " & ChrW(1490) & ChrW(1493) & ChrW(1512) & ChrW(1504) & ChrW(1496) & ChrW(1511) & " 054-6677396 - v" & APP_VERSION
...
155         wsMain.Range("rngPeriodValue").Value = ""
            On Error Resume Next
160         wsMain.Activate
161         wsMain.Range("rngDateType").Select
            On Error GoTo ERR_HANDLER
            GoTo CLEAN_EXIT
170     Else
            GoTo CLEAN_EXIT
