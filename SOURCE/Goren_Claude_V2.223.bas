Attribute VB_Name = "Goren_Claude_V2_223"
...
' DATE: 2026-07-08 17:22:21 (LATEST FIXES)
' ============================================================================
' CHANGES IN 1.51:
...
Private Const APP_VERSION As String = "2.222"
...
Private Function SOURCE_FOLDER() As String
    ...
    If SOURCE_FOLDER = "" Then
        SOURCE_FOLDER = ThisWorkbook.Path & "\SOURCE\"
    End If
...
Public Sub BuildReview()
    ...
    On Error Resume Next: ThisWorkbook.Unprotect "Z961814r": On Error GoTo 0
...
280     Dim rng As Range
    ...
    On Error Resume Next: ThisWorkbook.Protect "Z961814r": On Error GoTo 0
                Exit Sub
            End If
        End If
...
Application.ScreenUpdating = True
Application.DisplayAlerts = True
1250    ThisWorkbook.Protect "Z961814r"
Exit Sub
...
Application.ScreenUpdating = True
Application.DisplayAlerts = True
2800    ThisWorkbook.Protect "Z961814r"
Exit Sub
...
'Application.ScreenUpdating = True
'Application.DisplayAlerts = True
220     ThisWorkbook.Protect "Z961814r"
Exit Sub
ERR_HANDLER:
      Application.EnableEvents = True
      Application.DisplayAlerts = True
...
'Application.ScreenUpdating = True
'Application.DisplayAlerts = True
160     ThisWorkbook.Protect "Z961814r"
Exit Sub
ERR_HANDLER:
      Application.EnableEvents = True
      Application.DisplayAlerts = True
...
isDemoMode = FORCE_DEMO_MODE
    ...
    If GetActiveAgencyName = "" Then
        GetActiveAgencyName = "Goren System"
    End If
End Function
...
1740 wsMain.Range("G3:G4").Interior.Color = RGB(230, 230, 230) ' Gray out visually
    ...
    On Error GoTo ERR_HANDLER
        ' Clear previous mess without removing background colors
    ...
    If shpInstall Is Nothing Then
        Set shpInstall = wsMain.Shapes.AddShape(msoShapeRectangle, wsMain.Range("E16").Left, wsMain.Range("E16").Top, 280, 80)
        shpInstall.Name = "shpInstallMsg"
    End If
    shpInstall.Fill.ForeColor.RGB = RGB(255, 200, 200) ' Prominent pastel pink
    shpInstall.Line.ForeColor.RGB = RGB(0, 0, 139)
    shpInstall.Line.Weight = 2
    
    With shpInstall.TextFrame2.TextRange
        .Text = ChrW(1492) & ChrW(1511) & ChrW(1513) & ChrW(32) & ChrW(1499) & ChrW(1488) & ChrW(1503) & ChrW(32) & ChrW(1500) & ChrW(1508) & ChrW(1514) & ChrW(1497) & ChrW(1495) & ChrW(1514) & ChrW(32) & ChrW(1492) & ChrW(1493) & ChrW(1512) & ChrW(1488) & ChrW(1493) & ChrW(1514) & ChrW(32) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & vbCrLf & _
ChrW(1504) & ChrW(1497) & ChrW(1514) & ChrW(1503) & ChrW(32) & ChrW(1500) & ChrW(1513) & ChrW(1500) & ChrW(1493) & ChrW(1495) & ChrW(32) & ChrW(1492) & ChrW(1493) & ChrW(1491) & ChrW(1506) & ChrW(1514) & ChrW(32) & ChrW(1493) & ChrW(1493) & ChrW(1488) & ChrW(1496) & ChrW(1505) & ChrW(1488) & ChrW(1508) & ChrW(32) & ChrW(1500) & ChrW(1496) & ChrW(1500) & ChrW(1508) & ChrW(1493) & ChrW(1503) & vbCrLf & _
"054-6677396" & vbCrLf & _
ChrW(1500) & ChrW(1511) & ChrW(1489) & ChrW(1500) & ChrW(1514) & ChrW(32) & ChrW(1506) & ChrW(1494) & ChrW(1512) & ChrW(1492)
        .Font.Size = 12
        .Font.Bold = msoTrue
...
shpInstall.OnAction = "OpenInstructions"
    On Error Resume Next
...
2020 wsMain.Range("G9").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:="=lst_empty"
    ...
    ' ---- Remove ONLY the specific buttons we are about to recreate ----
...
shapesToDelete = Array("btnBuildReview", "btnApplyCorrections", "btnShowResults", _
                       ...
                       "btnResetDefaults", "btnShowHidden", "btnNavExit", "shpBtn", "shpDemoMsgText", "shpDismissMsg")
...
4690 wsParams.Cells(paramLastRow + 1, COL_PARAM_VALUE).Value = ThisWorkbook.Path & "\BACKUPS"
4700 End If
...
4960 ThisWorkbook.Protect "Z961814r"
Exit Sub
ERR_HANDLER:
    Dim errNum As Long
    Dim errDesc As String
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.222!" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
...
210     ThisWorkbook.Protect "Z961814r"
Exit Sub
...
240     imgTotal = tmpPath & "demo_total.gif"
...
500         imgFiles(si * 4 - 3) = tmpPath & "demo_prem_" & si & ".gif"
510         imgFiles(si * 4 - 2) = tmpPath & "demo_comm_" & si & ".gif"
            imgFiles(si * 4 - 1) = tmpPath & "demo_docs_" & si & ".gif"
            imgFiles(si * 4) = tmpPath & "demo_ins_" & si & ".gif"
...
850     Next si
        ...
        ' ================================================================
        ' PHASE 3: "Agents without Demo" variant slides (2 chart slides)
        ' ================================================================
        If SheetExists(SHEET_AGENTS()) Then
            Dim imgNoDemoPrem As String
            Dim imgNoDemoComm As String
            Dim noDemoOK As Boolean
            ' levav = ChrW(1500) & ChrW(1489) & ChrW(1489)
            Dim demoName As String
demoName = GetActiveAgencyName()
            imgNoDemoPrem = tmpPath & "demo_nodem_prem.gif"
            imgNoDemoComm = tmpPath & "demo_nodem_comm.gif"
            noDemoOK = False
            On Error Resume Next
            ExportCompCharts SHEET_AGENTS(), imgNoDemoPrem, imgNoDemoComm, yearVal, refYear, demoName
            If Err.Number = 0 Then noDemoOK = True
            Err.Clear
            ...
            If noDemoOK Then
                ...
                slideIdx = slideIdx + 1
                Set ppSlide = ppPres.Slides.Add(slideIdx, 12)
                ' title: premiot lefi sochnim lelo demo
                BuildChartSlide ppSlide, imgNoDemoPrem, ChrW(1508) & ChrW(1512) & ChrW(1502) & ChrW(1497) & ChrW(1493) & _
        ...
        GetActiveAgencyName(), yearVal, refYear, slideW, paramsSubtitle
                ...
                slideIdx = slideIdx + 1
                Set ppSlide = ppPres.Slides.Add(slideIdx, 12)
                ' title: amlot lefi sochnim lelo demo
                BuildChartSlide ppSlide, imgNoDemoComm, ChrW(1506) & ChrW(1502) & ChrW(1500) & ChrW(1493) & ChrW(1514) & _
...
906         ppPres.SaveAs finalPdfPath, 32
        ...
        If Not bSaved Then
            ...
            tmpSavePath = Environ$("TEMP") & "\" & "DemoTemp_" & yearVal & ".pptx"
            Kill tmpSavePath
            Err.Clear
...
1060    ThisWorkbook.Protect "Z961814r"
Exit Sub
...
tmpName = ShortenCompanyName(Trim$(CStr(ws.Cells(r, 1).Value2)))
            ' Skip excluded name (for "agents without Demo" variant)
...
Application.ScreenUpdating = True
Application.DisplayAlerts = True
960     ThisWorkbook.Protect "Z961814r"
Exit Sub
...
Public Sub SetupSettingsSheet()
    ...
    shp.TextFrame2.TextRange.Text = ChrW(1492) & ChrW(1511) & ChrW(1513) & ChrW(32) & ChrW(1499) & ChrW(1488) & ChrW(1503) & ChrW(32) & ChrW(1500) & ChrW(1508) & ChrW(1514) & ChrW(1497) & ChrW(1495) & ChrW(1514) & ChrW(32) & ChrW(1492) & ChrW(1493) & ChrW(1512) & ChrW(1488) & ChrW(1493) & ChrW(1514) & ChrW(32) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & ChrW(46) & vbCrLf & _
ChrW(1504) & ChrW(1497) & ChrW(1514) & ChrW(1503) & ChrW(32) & ChrW(1500) & ChrW(1513) & ChrW(1500) & ChrW(1493) & ChrW(1495) & ChrW(32) & "WhatsApp " & ChrW(1500) & ChrW(1496) & ChrW(1500) & ChrW(1508) & ChrW(1493) & ChrW(1503) & ChrW(32) & "054-6677396" & vbCrLf & _
ChrW(1500) & ChrW(1511) & ChrW(1489) & ChrW(1500) & ChrW(1514) & ChrW(32) & ChrW(1506) & ChrW(1494) & ChrW(1512) & ChrW(1492) & ChrW(32) & ChrW(1489) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & ChrW(46)
        .Font.Size = 18
...
Public Sub CreateInstructionSheets()
    ...
    With wsOp
        ...
        btnOp.TextFrame2.TextRange.Text = ChrW(1492) & ChrW(1511) & ChrW(1513) & ChrW(32) & ChrW(1499) & ChrW(1488) & ChrW(1503) & ChrW(32) & ChrW(1500) & ChrW(1508) & ChrW(1514) & ChrW(1497) & ChrW(1495) & ChrW(1514) & ChrW(32) & ChrW(1492) & ChrW(1493) & ChrW(1512) & ChrW(1488) & ChrW(1493) & ChrW(1514) & ChrW(32) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & ChrW(46) & vbCrLf & _
ChrW(1504) & ChrW(1497) & ChrW(1514) & ChrW(1503) & ChrW(32) & ChrW(1500) & ChrW(1513) & ChrW(1500) & ChrW(1493) & ChrW(1495) & ChrW(32) & "WhatsApp " & ChrW(1500) & ChrW(1496) & ChrW(1500) & ChrW(1508) & ChrW(1493) & ChrW(1503) & ChrW(32) & "054-6677396" & vbCrLf & _
ChrW(1500) & ChrW(1511) & ChrW(1489) & ChrW(1500) & ChrW(1514) & ChrW(32) & ChrW(1506) & ChrW(1494) & ChrW(1512) & ChrW(1492) & ChrW(32) & ChrW(1489) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & ChrW(46)
        .Font.Size = 14
...
Private Sub LogDebug(ByVal msg As String)
    ...
    Dim ff As Integer
    ff = FreeFile
    Open ThisWorkbook.Path & "\debug_log.txt" For Append As #ff
...
Public Sub SetupInstructionsSheet()
    ...
    Set shp = wsInst.Shapes.AddShape(msoShapeRoundedRectangle, wsInst.Range("A20").Left + 150, wsInst.Range("A20").Top, 250, 40)
...
Public Sub OpenManual()
    On Error Resume Next
    ActiveWorkbook.FollowHyperlink "https://gorentec-my.sharepoint.com/:b:/g/personal/zvi_gorentech_co_il/IQBt2Ms0oWLySpRBl-6OY68MAXnBN2jyzpD3y43ZHmIUBwU?e=y10XmN"
    On Error GoTo 0
End Sub
...
Public Sub OpenInstallWeb()
    ...
    ActiveWorkbook.FollowHyperlink "https://gorentec-my.sharepoint.com/:x:/g/personal/zvi_gorentech_co_il/IQBnB0klIujxR4O5fALynO8EAWddhgVppMJI7THxhW3R6fo?e=Z8iVEV"
    On Error GoTo 0
End Sub
...
Public Sub ApplyDemoLockOnOpen(Optional ByVal isSetup As Boolean = False)
    Dim wsMain As Worksheet
    On Error Resume Next
    Set wsMain = ThisWorkbook.Worksheets(CONTROL_SHEET_NAME())
    If wsMain Is Nothing Then Exit Sub
    ...
    With wsMain.Shapes("shpInstallMsg")
        .OnAction = ""
        .TextFrame2.TextRange.Text = ChrW(1504) & ChrW(1497) & ChrW(1514) & ChrW(1503) & ChrW(32) & ChrW(1500) & ChrW(1513) & ChrW(1500) & ChrW(1493) & ChrW(1495) & ChrW(32) & ChrW(1492) & ChrW(1493) & ChrW(1491) & ChrW(1506) & ChrW(1514) & ChrW(32) & ChrW(1493) & ChrW(1493) & ChrW(1488) & ChrW(1496) & ChrW(1505) & ChrW(1488) & ChrW(1508) & ChrW(32) & ChrW(1500) & ChrW(1496) & ChrW(1500) & ChrW(1508) & ChrW(1493) & ChrW(1503) & vbCrLf & _
"054-6677396" & vbCrLf & _
ChrW(1500) & ChrW(1511) & ChrW(1489) & ChrW(1500) & ChrW(1514) & ChrW(32) & ChrW(1506) & ChrW(1494) & ChrW(1512) & ChrW(1492)
    End With
    On Error GoTo 0
