Attribute VB_Name = "Goren_Claude1_94"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.94"
...
1040    debugStep = "CHECK_SRC"
        ...
        If Not testWs Is Nothing Then
            If FORCE_DEMO_MODE Then isDemoMode = True
        End If
...
1090        Set wsSrc = OpenDataSheet(wbSrc)
    ...
    BuildBaseSheet wsSrc, wsBase, baseSheetName, _
        ...
        On Error GoTo ERR_HANDLER
        If Not testRefWs Is Nothing Then
            If FORCE_DEMO_MODE Then isRefDemoMode = True
        End If
...
Public Sub SetupSectionNamedRanges()
    ...
    ThisWorkbook.Names.Add "rngSection_PeriodLists", wsMgmt.Range("A" & 230 + offsetRow)
    ThisWorkbook.Names.Add "rngSection_Messages", wsMgmt.Range("A" & 280 + offsetRow)
    ThisWorkbook.Names.Add "rngSection_Permissions", wsMgmt.Range("A" & 300 + offsetRow)
    ThisWorkbook.Names.Add "rngSection_Clients", wsMgmt.Range("A" & 320 + offsetRow)
