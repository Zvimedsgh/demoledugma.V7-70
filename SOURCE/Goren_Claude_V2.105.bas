Attribute VB_Name = "Goren_Claude_V2_105"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.105"
...
2020 wsMain.Range("G9").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:="=lst_empty"
    ...
    3430 wsMain.Range("A1").Value = GetActiveAgencyName()
    3440 wsMain.Range("A1").Font.Size = 28
    3450 wsMain.Range("A1").Font.Bold = True
    3460 wsMain.Range("A1").Font.Color = RGB(200, 0, 0)
