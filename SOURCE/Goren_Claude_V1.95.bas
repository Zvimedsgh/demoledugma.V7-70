Attribute VB_Name = "Goren_Claude1_95"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.95"
...
530     Dim isDemoMode As Boolean
        ...
        demoParam = UCase$(Trim$(GetStringParameter("DEMO_MODE")))
...
1090        Set wsSrc = OpenDataSheet(wbSrc)
    ...
    BuildBaseSheet wsSrc, wsBase, baseSheetName, _
        ...
        refDemoParam = UCase$(Trim$(GetStringParameter("DEMO_MODE")))
