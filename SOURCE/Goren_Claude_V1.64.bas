...
Public Sub ExitSystem()
    ...
    ans = MsgBoxU(ChrW(1492) & ChrW(1488) & ChrW(1501) & " " & ChrW(1488) & ChrW(1514) & ChrW(1492) & " " & ChrW(1489) & ChrW(1496) & ChrW(1493) & ChrW(1495) & " " & ChrW(1513) & ChrW(1489) & ChrW(1512) & ChrW(1510) & ChrW(1493) & ChrW(1504) & ChrW(1498) & " " & ChrW(1500) & ChrW(1510) & ChrW(1488) & ChrW(1514) & " " & ChrW(1502) & ChrW(1492) & ChrW(1502) & ChrW(1506) & ChrW(1512) & ChrW(1499) & ChrW(1514) & "?", vbYesNo + vbQuestion + vbDefaultButton2, ChrW(1497) & ChrW(1510) & ChrW(1497) & ChrW(1488) & ChrW(1492))
    If ans = vbYes Then
        ThisWorkbook.Save
        Application.Quit
    End If
...
Public Sub CheckUserPermissions()
    ...
    wsMain.Range("A21:M21").HorizontalAlignment = 7 ' xlCenterAcrossSelection
