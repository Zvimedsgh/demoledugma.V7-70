Attribute VB_Name = "Goren_Claude1_96"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.96"
...
1040    debugStep = "CHECK_SRC"
        ...
        If isDemoMode Then
            ...
            On Error Resume Next
            Set testWs = ThisWorkbook.Worksheets("DATA_" & yearVal)
            On Error GoTo ERR_HANDLER
            If Not testWs Is Nothing Then Set wbSrc = ThisWorkbook
        End If
            On Error Resume Next
            Set wsSrc = ThisWorkbook.Worksheets("DATA_" & yearVal)
            On Error GoTo ERR_HANDLER
...
1090        Set wsSrc = OpenDataSheet(wbSrc)
    ...
    BuildBaseSheet wsSrc, wsBase, baseSheetName, _
        ...
        If isRefDemoMode Then
            Dim testRefWs As Worksheet
            On Error Resume Next
            Set testRefWs = ThisWorkbook.Worksheets("DATA_" & refYear)
            On Error GoTo ERR_HANDLER
            If Not testRefWs Is Nothing Then Set wbRef = ThisWorkbook
        End If
            On Error Resume Next
