Attribute VB_Name = "Goren_Claude1_74"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.74"
...
Public Sub CheckUserPermissions()
    ...
    If Len(creditVersionCell) > 0 And creditVersionCell <> "A23" Then
        ...
        Err.Clear
    End If
    wsMain.Range("F20").Value = creditText & " - v" & APP_VERSION
    wsMain.Range("F20").Font.Size = 10
    wsMain.Range("F20").Font.Color = RGB(150, 150, 150)
    wsMain.Range("F20").Font.Bold = False
    wsMain.Range("F20").HorizontalAlignment = -4108 ' xlCenterAcrossSelection
