Attribute VB_Name = "Goren_Claude_V2_261"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.261"
...
1750 Else
    ...
    On Error GoTo ERR_HANDLER
    1760 With wsMain.Range("G3").Validation
.Delete
End With
...
3680 btnReset.Name = "btnResetDefaults"
    ...
    3760 Set shp = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("L19").Left, wsMain.Range("L19").Top, 160, 30)
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.261! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
...
Public Sub ApplyDemoLockOnOpen()
    ...
    If isDemoMode Then
        ...
        On Error Resume Next
        wsMain.Range("G3").Validation.Delete
...
wsMain.Range("G4").MergeArea.Interior.Color = RGB(255, 245, 230)
        On Error Resume Next
        With wsMain.Range("G3").Validation
.Delete
End With
With wsMain.Range("G4").Validation
            .Delete
