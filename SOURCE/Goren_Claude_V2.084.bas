Attribute VB_Name = "Goren_Claude_V2_084"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.084"
...
761                 For j = 1 To cnt
762                     wsRev.Cells(outRow, j + 1).Value = srcData(r, cols(j))
763                 Next j
...
831                     For j = 1 To cnt
832                         wsRev.Cells(outRow, j + 1).Value = srcData(r, cols(j))
833                     Next j
...
861                 For j = 1 To cnt
862                     wsRev.Cells(outRow, j + 1).Value = srcData(r, cols(j))
863                 Next j
...
931                 For j = 1 To cnt
932                     wsRev.Cells(outRow, j + 1).Value = srcData(r, cols(j))
933                 Next j
