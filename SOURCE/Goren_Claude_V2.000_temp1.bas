...
320  lblSugTaarih = ChrW(1505) & ChrW(1493) & ChrW(1490) & " " & ChrW(1514) & ChrW(1488) & ChrW(1512) & ChrW(1497) & ChrW(1498)
    ...
    If wsMgmt.Range("A" & rPerm).Value <> ChrW(1492) & ChrW(1512) & ChrW(1513) & ChrW(1488) & ChrW(1493) & ChrW(1514) Then
        ' 1. Ignore Codes
        ...
        wsMgmt.Range("A" & (rMsg + 30)).Value = "EOD"
        ...
        wsMgmt.Range("B" & (rPerm + 1)).Value = ChrW(1502) & ChrW(1500) & ChrW(1488)
        wsMgmt.Range("A" & (rPerm + 2)).Value = "claude"
        wsMgmt.Range("B" & (rPerm + 2)).Value = ChrW(1502) & ChrW(1500) & ChrW(1488)
        wsMgmt.Range("A" & (rPerm + 15)).Value = "EOD"
        ...
        wsMgmt.Range("A" & (rClient + 3)).Value = "EOD"
    End If
    ...
    wsMgmt.Cells(periodBaseRow + 4, 1).Value = ChrW(1512) & ChrW(1489) & ChrW(1506) & ChrW(1493) & ChrW(1503)
