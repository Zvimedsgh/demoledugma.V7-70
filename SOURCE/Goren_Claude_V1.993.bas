Attribute VB_Name = "Goren_Claude1_993"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "1.993"
...
380 wsMgmt.Cells(startRow, 1).Font.Size = 12
    ' Clear old list (rows startRow+1 up to EOD marker or empty cell)
    Dim clearLast As Long
    clearLast = startRow
    Do While Trim$(CStr(wsMgmt.Cells(clearLast + 1, 1).Value2)) <> EOD_MARKER And Trim$(CStr(wsMgmt.Cells(clearLast + 1, 1).Value2)) <> ""
        clearLast = clearLast + 1
    Loop
    If clearLast > startRow Then wsMgmt.Range(wsMgmt.Cells(startRow + 1, 1), wsMgmt.Cells(clearLast, 1)).ClearContents
