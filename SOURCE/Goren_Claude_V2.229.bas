Attribute VB_Name = "Goren_Claude_V2_229"
' ============================================================================
' MODULE: modLevav
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.229! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
