...
If SheetExists(currentYear & "_FIXED") Then
    Set wsCur = ThisWorkbook.Worksheets(currentYear & "_FIXED")
ElseIf SheetExists(currentYear & "_fixed") Then
    Set wsCur = ThisWorkbook.Worksheets(currentYear & "_fixed")
Else
    Err.Raise vbObjectError + 2500, , "Missing current fixed sheet: " & currentYear & "_FIXED"
End If
