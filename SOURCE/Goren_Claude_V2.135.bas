Attribute VB_Name = "Goren_Claude_V2_120"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.120"
...
1740 wsMain.Range("G3:G4").Interior.Color = RGB(230, 230, 230) ' Gray out visually
    ...
    Set shpDemoMsg = wsMain.Shapes.AddTextbox(1, wsMain.Range("F19").Left, wsMain.Range("F19").Top, 500, 40)
    shpDemoMsg.Name = "shpDemoMsgText"
3687 shpDemoMsg.TextFrame2.TextRange.Text = ChrW(1500) & ChrW(1492) & ChrW(1514) & ChrW(1511) & ChrW(1504) & ChrW(1492) & " " & ChrW(1493) & ChrW(1492) & ChrW(1491) & ChrW(1512) & ChrW(1499) & ChrW(1492) & " " & ChrW(1513) & ChrW(1500) & ChrW(1495) & " Whatsapp " & ChrW(8207) & ChrW(1500) & "-054-6677396"
