Attribute VB_Name = "Goren_Claude_V2_074"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.074"
...
1570 isDemoMode = FORCE_DEMO_MODE
    ...
    1650 If isDemoMode Then
        ...
        1680 With wsMain.Range("G3:G4").Validation
            1690 .Delete
            1700 .Add Type:=xlValidateCustom, AlertStyle:=xlValidAlertStop, Formula1:="=FALSE"
