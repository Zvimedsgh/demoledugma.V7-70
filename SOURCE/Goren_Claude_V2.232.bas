Attribute VB_Name = "Goren_Claude_V2_232"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.232"
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.232! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
...
Public Sub ApplyDemoLockOnOpen()
    ...
    Set shpManual = wsMain.Shapes.AddShape(msoShapeOval, wsMain.Range("L1").Left, wsMain.Range("L1").Top, 120, 80)
