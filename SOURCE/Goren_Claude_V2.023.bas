Attribute VB_Name = "Goren_Claude_V2_023"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.023"
...
320  lblSugTaarih = ChrW(1505) & ChrW(1493) & ChrW(1490) & " " & ChrW(1514) & ChrW(1488) & ChrW(1512) & ChrW(1497) & ChrW(1498)
    ...
    Set shpTitle = wsMain.Shapes.AddTextbox(1, wsMain.Range("E1").Left - 300, wsMain.Range("E1").Top, 600, 40)
