Attribute VB_Name = "Goren_Claude_V2_272"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.272"
...
' 3970 wsMain.Range("F19").ClearContents
    ...
    On Error GoTo ERR_HANDLER
    Set shpOpManual = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, btnLeft, wsMain.Range("C16").Top, btnW, btnH)
    ...
    On Error GoTo ERR_HANDLER
    Set shpToggle = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, btnLeft, wsMain.Range("C18").Top, btnW, btnH)
    ...
    On Error GoTo ERR_HANDLER
    Set shpToggleLayout = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, btnLeft, wsMain.Range("C20").Top, btnW, btnH)
    ...
    shpToggleLayout.TextFrame2.TextRange.Font.Size = 12
    ...
    On Error GoTo ERR_HANDLER
    Set shpExit = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, btnLeft, wsMain.Range("C22").Top, btnW, btnH)
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.272! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
