...
' 3970 wsMain.Range("F19").ClearContents
    ...
    shpToggle.TextFrame2.TextRange            .Text = ChrW(1492) & ChrW(1502) & ChrW(1510) & ChrW(1490) & ChrW(1514) & " " & _
...
End Sub' Final Summary Slide (V3.56 - Stacked buttons, working Coffee slide)
