Attribute VB_Name = "Goren_Claude_V2_191"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.191"
...
Public Sub CreateInstructionSheets()
    ...
    With wsOp
        ...
        ChrW(1513) & ChrW(1493) & ChrW(1501) & " " & ChrW(1493) & ChrW(1491) & ChrW(1493) & """ & ChrW(1495) & ChrW(1493) & _
        ChrW(1514) & ":"
