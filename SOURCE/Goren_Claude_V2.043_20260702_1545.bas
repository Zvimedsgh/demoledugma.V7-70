Attribute VB_Name = "Goren_Claude_V2_043"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.043"
...
ThisWorkbook.Names.Add "lst_period_type", wsTemp.Range(wsTemp.Cells(3, 1), wsTemp.Cells(6, 1))
    ...
    wsMain.Range("G6").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, _
        Formula1:="=IF($G$5=""" & tHalf & """,lst_half_year,IF($G$5=""" & tQuarter & """,lst_quarter,IF($G$5=""" & tMonth & """,lst_month,lst_empty)))"
    ...
    wsMain.Range("G9").MergeArea.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, _
        Formula1:="=IF($G$8=""" & tBranch & """,lst_branches,IF($G$8=""" & tAgent & """,lst_agents,IF($G$8=""" & tTeller & """,lst_tellers,IF($G$8=""" & tComp & """,lst_companies,IF($G$8=""" & tMainBranch & """,lst_main_branches,lst_empty)))))"
    Err.Clear
    On Error GoTo ERR_HANDLER
...
2050  End If
      ...
      If Not foundDemo Then
          ...
          wsParams.Cells(paramLastRow + 1, COL_PARAM_VALUE).Value = ChrW(1500) & ChrW(1488) 'לא
          paramLastRow = paramLastRow + 1
      End If
