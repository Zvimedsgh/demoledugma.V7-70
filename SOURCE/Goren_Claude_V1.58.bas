...
Public Sub SetupSettingsMenu()
    ...
    ' Calculate the total width of 5 buttons to anchor the block to the right margin
    blockWidth = (5 * btnW) + (4 * 10)
    ...
    ' Set initial position for Row 1
    btnLeft = initialLeft
    ...
    ' Reset btnLeft to initialLeft for ROW 2 so they perfectly align under Row 1!
    btnLeft = initialLeft
