Attribute VB_Name = "Goren_Claude_V2_220"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "2.220"
...
4910 Application.Goto wsMain.Range("F3")
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.079! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
...
1040    End With
        ...
        On Error Resume Next
        wsMain.Activate
        Application.Goto wsMain.Range("F3")
        On Error GoTo ERR_HANDLER
...
Public Sub NavToIndex()
    ...
    Call HideWorkSheets
    On Error Resume Next
    Application.Goto ThisWorkbook.Worksheets(CONTROL_SHEET_NAME()).Range("F3")
End Sub
...
Public Sub SetupInstructionsSheet()
    ...
    Set shp = wsInst.Shapes.AddShape(msoShapeRoundedRectangle, wsInst.Range("C20").Left, wsInst.Range("C20").Top, 250, 40)
