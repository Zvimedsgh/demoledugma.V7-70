Attribute VB_Name = "Levav_Manus_V9_3"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "9.3"
...
2200  filterTypeList = ChrW(1489) & ChrW(1495) & ChrW(1512) & ChrW(47) & ChrW(1497) & "," & H_COMPANY() & "," & H_TELLER() & "," & H_AGENT() & "," & H_BRANCH() & "," & H_BRANCH() & " " & ChrW(1502) & ChrW(1512) & ChrW(1499) & ChrW(1494)
