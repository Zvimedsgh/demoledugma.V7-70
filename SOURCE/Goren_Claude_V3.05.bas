Attribute VB_Name = "Goren_Claude_V3_05"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "3.05"
...
4940 ApplyDemoLockOnOpen
    ...
    ' Add Yes/No Dropdown dynamically to DEMO_MODE value cell (Column C)
    On Error Resume Next
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V3.05! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
