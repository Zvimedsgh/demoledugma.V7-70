Attribute VB_Name = "Goren_Claude_V2_242"
' ============================================================================
' MODULE: modLevav
...
' DATE: 2026-07-08 17:44:11 (LATEST FIXES)
' ============================================================================
' CHANGES IN 1.51:
...
Private Const APP_VERSION As String = "2.242"
...
ERR_HANDLER:
    ...
    If errNum <> 0 Then
        On Error Resume Next
        MsgBoxU "Error in V2.242! (If you don't see this, you are running old code!)" & vbCrLf & "Desc: " & errDesc & vbCrLf & "Line: " & errLine & vbCrLf & "Num: " & errNum, vbCritical, "Setup Error"
    End If
...
Public Sub NavToIndex()
    ...
    Call HideWorkSheets
    On Error Resume Next
    Application.Goto ThisWorkbook.Worksheets(CONTROL_SHEET_NAME()).Range("F10")
End Sub
...
Public Sub ApplyDemoLockOnOpen()
    ...
    If isDemoMode Then
        ...
        Dim shpInstall As Shape
        Set shpInstall = wsMain.Shapes.AddShape(msoShapeRoundedRectangle, wsMain.Range("F15").Left, wsMain.Range("F15").Top, 250, 90)
        shpInstall.Name = "shpInstallMsg"
        shpInstall.Fill.ForeColor.RGB = RGB(255, 204, 229) ' Pastel Pink
        shpInstall.Line.ForeColor.RGB = RGB(0, 0, 139)
        shpInstall.Line.Weight = 2
        ...
        End With
        shpInstall.TextFrame2.VerticalAnchor = msoAnchorMiddle
        shpInstall.OnAction = "OpenInstallInstructions"
...
Next ws
    ...
    ApplyDemoLockOnOpen
    Application.Goto wsMainUI.Range("F10")
...
Public Sub CreateInstructionSheets()
    ...
    With wsInstall
        ...
        .Range("B4").Value = ChrW(1492) & ChrW(1490) & ChrW(1506) & ChrW(1514) & ChrW(1501) & " " & ChrW(1500) & ChrW(1502) & _
        ...
        ChrW(1502) & ChrW(1500) & ChrW(1488) & ChrW(1492) & " " & ChrW(1489) & ChrW(1502) & ChrW(1495) & ChrW(1513) & ChrW(1489) & _
