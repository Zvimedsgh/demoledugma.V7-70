Attribute VB_Name = "Goren_Claude_V3_22"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "3.22"
...
1742 wsMain.Range("G4").MergeArea.Interior.Color = RGB(230, 230, 230)
    ...
    On Error GoTo ER    ' Pink instruction message box removed in V3.22 per user request
