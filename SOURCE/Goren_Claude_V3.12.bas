Attribute VB_Name = "Goren_Claude_V3_12"
' ============================================================================
' MODULE: modLevav
...
Private Const APP_VERSION As String = "3.12"


Private Const APP_DATE As String = "02/07/2026 11:00"
Private Const FORCE_DEMO_MODE As Boolean = True  ' FORCED TRUE FOR TESTING
...
Public Sub CheckUserPermissions()
    ...
    If Not FORCE_DEMO_MODE Then
        If demoParamStr = ChrW(1499) & ChrW(1503) Or demoParamStr = "YES" Or demoParamStr = "" Then isSysDemo = True
        If demoParamStr = ChrW(1500) & ChrW(1488) Or demoParamStr = "NO" Then isSysDemo = False
    End If
    On Error GoTo PERM_ERR
    
    ' Universal Access for Demo: If system is in DEMO, grant full access to EVERYONE
    If isSysDemo Then
